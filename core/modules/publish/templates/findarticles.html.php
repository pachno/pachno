...
<div class="main_area article">
    ...
    <form action="<?php echo (\pachno\core\framework\Context::isProjectContext()) ? make_url('publish_find_project_articles', array('project_key' => \pachno\core\framework\Context::getCurrentProject()->getKey())) : make_url('publish_find_articles'); ?>" method="get" accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>">
        ...
        <?php if ($resultcount): ?>
            ...
            <ul class="simple-list wiki-find-articles-list">
                ...
                <li style="margin-bottom: 0;">
                    ...
                    <div class="faded_out"><?php echo __('Last updated %updated_at', array('%updated_at' => \pachno\core\framework\Context::getI18n()->formatTime($article->getLastUpdatedDate(), 6))); ?></div>
                    <div class="article_preview">
                        <?php echo pachno_truncateText($article->getContent()); ?>
                    </div>
                </li>
                <?php endforeach; ?>
            </ul>
