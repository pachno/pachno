                ...
                <?php foreach($latest_articles as $article): ?>
                    <li>
                        <div>
                            ...
                            <?php echo link_tag(make_url('publish_article', array('article_name' => $article->getName())), \pachno\core\framework\Settings::get('allow_camelcase_links', 'publish', \pachno\core\framework\Context::getScope()->getID(), 0) ? get_spaced_name($article->getTitle()) : $article->getTitle()); ?>
                            <br>
