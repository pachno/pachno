<div class="article">
    ...
    <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
        <div class="greybox" style="margin: 15px 0;">
            <?php echo __('Note: This page lists all templates for "%project_name". For a list of global templates, see %all_templates', array('%project_name' => \pachno\core\framework\Context::getCurrentProject()->getName(), '%all_templates' => link_tag(make_url('publish_article', array('article_name' => "Special:AllTemplates")), 'Special:AllTemplates'))); ?>
        </div>
    <?php endif; ?>
    <p>
