<div id="viewissue_no_uploaded_files"<?php if (count($article->getFiles()) > 0): ?> style="display: none;"<?php endif; ?>><?php echo __('There are no file attached to this article'); ?></div>
