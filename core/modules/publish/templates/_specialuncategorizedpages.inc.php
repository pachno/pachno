<div class="article">
    ...
    <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
        <div class="greybox" style="margin: 15px 0;">
            <?php echo __('Note: This page lists all articles without categories in "%project_name". For a list of global articles with no categories, see %uncategorized_pages', array('%project_name' => \pachno\core\framework\Context::getCurrentProject()->getName(), '%uncategorized_pages' => link_tag(make_url('publish_article', array('article_name' => "Special:UncategorizedPages")), 'Special:UncategorizedPages'))); ?>
        </div>
    <?php endif; ?>
    <p>
