<div class="article">
    ...
    <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
        <div class="greybox" style="margin: 15px 0;">
            <?php echo __('Note: This page lists all articles that are not linked to for "%project_name". For a list of global articles that are not linked to, see %orphaned_pages', array('%project_name' => \pachno\core\framework\Context::getCurrentProject()->getName(), '%orphaned_pages' => link_tag(make_url('publish_article', array('article_name' => "Special:OrphanedPages")), 'Special:OrphanedPages'))); ?>
        </div>
    <?php endif; ?>
    <p>
