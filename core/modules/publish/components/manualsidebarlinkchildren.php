...
?>
<div id="article-<?= $main_article->getId(); ?>-children-container" class="submenu dynamic_menu populate-once" data-menu-url="<?= make_url('publish_api_article_menu', ['article_id' => $main_article->getID(), 'selected_article_id' => $article->getID()]); ?>" <?php if (isset($loaded)) echo ' data-is-loaded=1'; ?>>
