<?php
    ...
    $article_name = ($article instanceof \pachno\core\entities\Article) ? $article->getName() : $article;
    ...
    <div class="content">
        <ul class="article_list special_pages">
            ...
            <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
                <li>
                    <?php echo image_tag('news_item.png', array('style' => 'float: left;'), false, 'publish'); ?>
                    <?php echo link_tag(make_url('publish_article', array('article_name' => 'Special:'.ucfirst(mb_strtolower(\pachno\core\framework\Context::getCurrentProject()->getKey())).':SpecialPages')), __('Project special pages')); ?>
                </li>
            <?php endif; ?>
            <li>
                <?php echo image_tag('news_item.png', array('style' => 'float: left;'), false, 'publish'); ?>
