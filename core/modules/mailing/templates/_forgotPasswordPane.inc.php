<div id="forgot_password_container" class="logindiv regular">
    ...
    <?php else: ?>
        <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('mailing_forgot'); ?>" method="post" id="forgot_password_form" onsubmit="Pachno.Main.Login.resetForgotPassword('<?php echo make_url('mailing_forgot'); ?>'); return false;">
            <?php if ($forgottenintro instanceof \pachno\core\entities\Article): ?>
