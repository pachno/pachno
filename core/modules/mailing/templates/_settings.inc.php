<?php use pachno\core\modules\mailing\Mailing; ?>
<style>
...
<form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_module', array('config_module' => $module->getName())); ?>" enctype="multipart/form-data" method="post">
    <div id="mailnotification_settings_container" style="margin: 10px 0 0 0;" class="mailer-type-<?php echo $module->getMailerType(); ?>">
        ...
        <table style="width: 680px;" class="padded_table" cellpadding=0 cellspacing=0 id="mailnotification_settings_table">
            ...
            <tr>
                ...
                <td style="width: auto;">
                    <input type="radio" class="fancy-checkbox" name="activation_needed" id="activation_needed_yes" value="1" <?php if ($module->isActivationNeeded()): ?>checked<?php endif; ?> <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>><label for="activation_needed_yes"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('Yes'); ?></label>
                    <input type="radio" class="fancy-checkbox" name="activation_needed" id="activation_needed_no" value="0" <?php if (!$module->isActivationNeeded()): ?>checked<?php endif; ?> <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>><label for="activation_needed_no"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('No'); ?></label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="from_name" id="from_name" value="<?php echo $module->getSetting('from_name'); ?>" style="width: 100%;"<?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="use_queue" class="fancy-checkbox" value="1" id="use_queue_yes"<?php if ($module->usesEmailQueue()): ?> checked<?php endif; ?> <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>>&nbsp;<label for="use_queue_yes"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('Yes'); ?></label>
                    <input type="radio" name="use_queue" class="fancy-checkbox" value="0" id="use_queue_no"<?php if (!$module->usesEmailQueue()): ?> checked<?php endif; ?> <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>>&nbsp;<label for="use_queue_no"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('No'); ?></label><br>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select name="mail_type" id="mailing_mail_type" <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>>
        ...
        <table style="width: 680px; margin-top: 10px;" class="padded_table" cellpadding=0 cellspacing=0 id="mail_type_smtp_info">
            <tr>
                ...
                <td style="width: auto;"><input type="text" name="smtp_host" id="smtp_host" value="<?php echo $module->getSetting('smtp_host'); ?>" style="width: 100%;"<?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>></td>
            </tr>
            <tr>
                <td style="padding: 5px;"><label for="smtp_port"><?php echo __('SMTP address port'); ?></label></td>
                <td><input type="text" name="smtp_port" id="smtp_port" value="<?php echo $module->getSetting('smtp_port'); ?>" style="width: 40px;"<?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select name="smtp_encryption" id="mailing_encryption" <?php echo ($access_level != \pachno\core\framework\Settings::ACCESS_FULL || !$module->isOutgoingNotificationsEnabled()) ? ' disabled' : ''; ?>>
