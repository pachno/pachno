...
To change when and how often we send these emails, update your account settings: <?php echo $module->generateURL('profile_account'), $module->generateURL('profile_account'); ?>