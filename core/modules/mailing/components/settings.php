...
<div class="configuration-content centered">
    ...
    <div id="mailnotification_settings_container" class="form-container mailer-type-<?php echo $module->getMailerType(); ?>">
        <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_module', array('config_module' => $module->getName())); ?>" id="mailing_settings_form" method="post" data-simple-submit>
