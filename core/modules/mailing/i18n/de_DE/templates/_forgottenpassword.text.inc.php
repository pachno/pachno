...
Um Ihr Passwort zu aendern, klicken Sie auf folgenden Link: <?php echo "\n".$module->generateUrl('auth_reset_password', array('user' => $user->getUsername(), 'reset_hash' => $user->getActivationKey()))."\n"; ?>
...
Um einzustellen wann und wie oft diese E-Mails versandt werden sollen, aktualisieren Sie Ihre Account-Einstellungen: <?php echo $module->generateURL('profile_account'), $module->generateURL('profile_account'); ?>
