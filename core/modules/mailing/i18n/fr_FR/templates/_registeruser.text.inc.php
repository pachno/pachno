...
Une personne a enregistr&eacute; le nom d'utilisation <b>%user_username%</b> avec Pachno, ici : %pachno_url%.

Avec de pouvoir utiliser le nouveau compte, vous devez le confirmer en allant sur le lien suivant :<br>
%link_to_activate%

Votre mot de passe est : %password%
et vous pouvez vous connecter avec ce mot de passe depuis le lien indiqu� ci-dessus.<br>
