                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\IssuetypeScheme::getAll() as $item): ?>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\WorkflowScheme::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Project::getAll() as $item): ?>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Issuetype::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Status::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Reproducability::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    <div class="header"><?php echo __('Severity values'); ?></div>
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Severity::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Category::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Priority::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="csv_data_box">
                                    ...
                                    <table class="cleantable">
                                        ...
                                        <tbody>
                                        <?php foreach (\pachno\core\entities\Resolution::getAll() as $item): ?>
                                            <tr><td><?php echo $item->getName(); ?></td><td><?php echo $item->getID(); ?></td></tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
