<?php
    ...
    $pachno_response->setTitle(__('Import data'));

?>
<table cellpadding=0 cellspacing=0 class="configuration_page">
    <tr>
        <?php include_component('configuration/leftmenu', array('selected_section' => \pachno\core\framework\Settings::CONFIGURATION_SECTION_IMPORT)); ?>
