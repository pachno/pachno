    ...
    <ul class="fields-list" id="issue_details_fieldslist_basics">
        <li id="shortname_field"<?php if (!$issue->isShortnameVisible()): ?> style="display: none;"<?php endif; ?> >
            ...
            <div class="value">
                ...
                <span class="faded_out" id="no_shortname"<?php if ($issue->hasShortname()): ?> style="display: none;"<?php endif; ?>><?= __('No label set'); ?></span>
            </div>
        </li>
    ...
    <ul class="issue_details fields-list" id="issue_details_fieldslist_pain">
        <li id="pain_bug_type_field" style="<?php if (!$issue->isUserPainVisible()): ?> display: none;<?php endif; ?>">
                ...
                <div class="value" id="pain_bug_type_content">
                    ...
                    <span class="faded_out" id="no_pain_bug_type"<?php if ($issue->hasPainBugType()): ?> style="display: none;"<?php endif; ?>><?= __('Not triaged'); ?></span>
                </div>
        </li>
        <li id="pain_likelihood_field" style="<?php if (!$issue->isUserPainVisible()): ?> display: none;<?php endif; ?>">
                ...
                <div class="value" id="pain_likelihood_content">
                    ...
                    <span class="faded_out" id="no_pain_likelihood"<?php if ($issue->hasPainLikelihood()): ?> style="display: none;"<?php endif; ?>><?= __('Not triaged'); ?></span>
                </div>
        </li>
        <li id="pain_effect_field" style="<?php if (!$issue->isUserPainVisible()): ?> display: none;<?php endif; ?>">
                ...
                <div class="value" id="pain_effect_content">
                    ...
                    <span class="faded_out" id="no_pain_effect"<?php if ($issue->hasPainEffect()): ?> style="display: none;"<?php endif; ?>><?= __('Not triaged'); ?></span>
                </div>
        </li>
    </ul>
</fieldset>
...
<fieldset>
    ...
    <ul class="issue_details fields-list" id="issue_details_fieldslist_people">
        <li id="owned_by_field" style="<?php if (!$issue->isOwnedByVisible()): ?> display: none;<?php endif; ?>">
            ...
            <div class="value dropper-container" id="owned_by_content">
                <div class="value-container dropper">
                    ...
                    <span class="faded_out" id="no_owned_by"<?php if ($issue->isOwned()): ?> style="display: none;"<?php endif; ?>><?= __('Not owned by anyone'); ?></span>
                    <?php if ($issue->isUpdateable() && $issue->canEditOwner()): ?>
                        <?= fa_image_tag('angle-down', ['dropdown-indicator']); ?>
                    <?php endif; ?>
                </div>
                <?php if ($issue->isUpdateable() && $issue->canEditOwner()): ?>
        ...
        <li id="assigned_to_field">
            ...
            <div class="value dropper-container" id="assigned_to_content">
                <div class="value-container dropper">
                    ...
                    <span class="faded_out" id="no_assigned_to"<?php if ($issue->isAssigned()): ?> style="display: none;"<?php endif; ?>><?= __('Not assigned to anyone'); ?></span>
        ...
        <li id="subscribers_field">
            ...
            <div class="tooltip from-above" style="width: 300px; font-size: 0.9em; margin-top: 10px; margin-left: 17px;"><?= __('Click here to show the list of subscribers'); ?></div>
        </li>
    </ul>
</fieldset>
<fieldset id="issue_timetracking_container">
    ...
    <ul class="issue_details fields-list" id="issue_details_fieldslist_time">
        <li id="posted_at_field">
            ...
            <div class="value">
                <time datetime="<?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getPosted(), 24); ?>" title="<?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getPosted(), 21); ?>" pubdate class="value-container"><?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getPosted(), 20); ?></time>
            </div>
        </li>
        <li id="updated_at_field">
            ...
            <div class="value">
                <time datetime="<?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getLastUpdatedTime(), 24); ?>" title="<?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getLastUpdatedTime(), 21); ?>" class="value-container"><?= \pachno\core\framework\Context::getI18n()->formatTime($issue->getLastUpdatedTime(), 20); ?></time>
            </div>
        </li>
        <li id="estimated_time_field"<?php if (!$issue->isEstimatedTimeVisible()): ?> style="display: none;"<?php endif; ?>>
                ...
                <div class="value dropper-container" id="estimated_time_content">
                    <div class="value-container dropper">
                        <span id="estimated_time_<?= $issue->getID(); ?>_name"<?php if (!$issue->hasEstimatedTime()): ?> style="display: none;"<?php endif; ?>>
                            <?= \pachno\core\entities\Issue::getFormattedTime($issue->getEstimatedTime(true, true)); ?>
                        </span>
                        <span class="faded_out" id="no_estimated_time_<?= $issue->getID(); ?>"<?php if ($issue->hasEstimatedTime()): ?> style="display: none;"<?php endif; ?>><?= __('Not estimated'); ?></span>
        ...
        <li id="spent_time_field" style="position: relative;<?php if (!$issue->isSpentTimeVisible()): ?> display: none;<?php endif; ?>">
                ...
                <div class="value" id="spent_time_content">
                    <span id="spent_time_<?= $issue->getID(); ?>_name"<?php if (!$issue->hasSpentTime()): ?> style="display: none;"<?php endif; ?>>
                        <a href="javascript:void(0)" onclick="Pachno.Main.Helpers.Backdrop.show('<?= make_url('get_partial_for_backdrop', array('key' => 'issue_spenttimes', 'issue_id' => $issue->getID())); ?>');" id="spent_time_<?= $issue->getID(); ?>_value"><?= \pachno\core\entities\Issue::getFormattedTime($issue->getSpentTime(true, true)); ?></a>
                    </span>
                    <span class="faded_out" id="no_spent_time_<?= $issue->getID(); ?>"<?php if ($issue->hasSpentTime()): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0)" onclick="Pachno.Main.Helpers.Backdrop.show('<?= make_url('get_partial_for_backdrop', array('key' => 'issue_spenttimes', 'issue_id' => $issue->getID())); ?>');"><?= __('No time spent'); ?></a></span>
            ...
            <div class="tooltip from-above" style="width: 300px; font-size: 0.9em; margin-top: 10px; margin-left: 17px;"><?= __('Click here to see time logged against this issue'); ?></div>
        </li>
    </ul>
</fieldset>
                                    ...
                                    switch ($info['type'])
                                    {
                                        case \pachno\core\entities\CustomDatatype::INPUT_TEXTAREA_SMALL:
                                            ...
                                            <span id="<?= $field; ?>_name"<?php if (!$info['name_visible']): ?> style="display: none;"<?php endif; ?>>
                                                <?= \pachno\core\helpers\TextParser::parseText($info['name'], false, null, array('headers' => false)); ?>
                                            </span>
                                            <span class="faded_out" id="no_<?= $field; ?>"<?php if (!$info['noname_visible']): ?> style="display: none;"<?php endif; ?>>
                                                <?= __('Not determined'); ?>
                                            </span>
                                            <?php
                                            break;
                                        ...
                                        case \pachno\core\entities\CustomDatatype::STATUS_CHOICE:
                                            ...
                                            ?><span id="<?= $field; ?>_name"<?php if (!$info['name_visible']): ?> style="display: none;"<?php endif; ?>><div class="status-badge" style="background-color: <?= $color; ?>;"><span><?= __($value); ?></span></div></span><span class="faded_out" id="no_<?= $field; ?>"<?php if (!$info['noname_visible']): ?> style="display: none;"<?php endif; ?>><?= __('Not determined'); ?></span><?php
                                            break;
                                        ...
                                        case \pachno\core\entities\CustomDatatype::DATETIME_PICKER:
                                            ...
                                            ?><span id="<?= $field; ?>_name"<?php if (!$info['name_visible']): ?> style="display: none;"<?php endif; ?>><?= $value; ?></span><span id="<?= $field; ?>_new_name" style="display: none;"><?= (int) $value; ?></span><span class="faded_out" id="no_<?= $field; ?>"<?php if (!$info['noname_visible']): ?> style="display: none;"<?php endif; ?>><?= __('Not set'); ?></span><?php
                                            break;
                                        default:
                                            ?><span id="<?= $field; ?>_name"<?php if (!$info['name_visible']): ?> style="display: none;"<?php endif; ?>><?= (filter_var($info['name'], FILTER_VALIDATE_URL) !== false) ? link_tag($info['name'], $info['name']) : $info['name']; ?></span><span class="faded_out" id="no_<?= $field; ?>"<?php if (!$info['noname_visible']): ?> style="display: none;"<?php endif; ?>><?= __('Not determined'); ?></span><?php
                                            break;
                                    }
                                ?>
                                    ...
                                    <?php else: ?>
                                        <div class="list-mode" id="<?= $field; ?>_change">
                                            ...
                                            <?php if ($info['type'] == \pachno\core\entities\CustomDatatype::DATETIME_PICKER): ?>
                                                <form id="customfield_<?= $field; ?>_form" method="post" class="list-item" accept-charset="<?= \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="" onsubmit="Pachno.Issues.Field.set('<?= make_url('issue_setfield', array('project_key' => $issue->getProject()->getKey(), 'issue_id' => $issue->getID(), 'field' => $field)); ?>', '<?= $field; ?>', 'customfield_<?= $field; ?>');return false;">
                                                    ...
                                                    <input type="hidden" name="<?= $field; ?>_value" value="<?= (int) $info['name'] - \pachno\core\framework\I18n::getTimezoneOffset(); ?>" id="<?= $field; ?>_value" />
                                            ...
                                            case \pachno\core\entities\CustomDatatype::STATUS_CHOICE:
                                                ...
                                                <a href="javascript:void(0);" class="list-item" onclick="Pachno.Issues.Field.set('<?= make_url('issue_setfield', array('project_key' => $issue->getProject()->getKey(), 'issue_id' => $issue->getID(), 'field' => $field, $field . '_value' => $choice->getID())); ?>', '<?= $field; ?>');">
                                                    <span class="status-badge" style="background-color: <?= ($choice instanceof \pachno\core\entities\Status) ? $choice->getColor() : '#FFF'; ?>;">
...
<div class="issue_details_detailed_toggler">
    <a href="javascript:void(0);" class="button" onclick="$('issue_details').toggleClassName('detailed');"><?= __('Show / hide more details'); ?>&nbsp;&raquo;</a>
</div>
<script type="text/javascript">
    var Pachno, jQuery;
