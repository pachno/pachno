        ...
        <ul>
            <?php foreach ($errors as $key => $error): ?>
                ...
                <?php elseif (is_bool($error)): ?>
                    <li>
                        <?php if ($key == 'title' || in_array($key, \pachno\core\entities\Datatype::getAvailableFields(true)) || in_array($key, array('pain_bug_type', 'pain_likelihood', 'pain_effect'))): ?>
                            <?php
                            ...
                            ?>
                        <?php elseif (\pachno\core\entities\CustomDatatype::doesKeyExist($key)): ?>
                            <?= __('Required field "%field_name" is missing or invalid', array('%field_name' => \pachno\core\entities\CustomDatatype::getByKey($key)->getDescription())); ?>
                        <?php else:

                            $event = new \pachno\core\framework\Event('core', 'reportissue.validationerror', $key);
            ...
            <?php foreach ($permission_errors as $key => $p_error): ?>
                ...
                <?php elseif (is_bool($p_error)): ?>
                    <li>
                        <?php if (in_array($key, \pachno\core\entities\Datatype::getAvailableFields(true))): ?>
                            <?php
                            ...
                            ?>
                        <?php else: ?>
                            <?= __('You don\'t have access to enter "%field_name"', array('%field_name' => \pachno\core\entities\CustomDatatype::getByKey($key)->getDescription())); ?>
                        <?php endif; ?>
                    </li>
                <?php else: ?>
                    <li><?= $p_error; ?></li>
...
<?php elseif ($issue instanceof \pachno\core\entities\Issue): ?>
    <div class="rounded_box report_issue_desc <?php if (!$pachno_request->isAjaxCall()): ?>green<?php endif; ?> borderless" style="margin-bottom: 10px;" id="report_issue_reported_issue_details">
    ...
    <a class="button" id="report_issue_report_another_button" onclick="[$(this), $('report_issue_form'), $('report_more_here'), $('report_form'), $('issuetype_list'), $('report_issue_reported_issue_details')].each(function (el) { Element.toggle(el, 'block'); });$('reportissue_container').removeClassName('medium');$('reportissue_container').addClassName('large');"><?= __('Report another issue'); ?></a>
<?php endif; ?>
<?php if ($pachno_request->isAjaxCall()): ?>
    <form action="<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey())); ?>" method="post" accept-charset="<?= \pachno\core\framework\Context::getI18n()->getCharset(); ?>" onsubmit="Pachno.Main.submitIssue('<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey(), 'return_format' => 'planning')); ?>');return false;" id="report_issue_form" style="<?php if (isset($issue) && $issue instanceof \pachno\core\entities\Issue) echo 'display: none;'; ?>">
<?php else: ?>
    <form action="<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey())); ?>" method="post" accept-charset="<?= \pachno\core\framework\Context::getI18n()->getCharset(); ?>">
<?php endif; ?>
    ...
    <?php if (count($issuetypes) > 0): ?>
        <div class="issuetype_list" id="issuetype_list"<?php if ($selected_issuetype instanceof \pachno\core\entities\Issuetype): ?> style="display: none;"<?php endif; ?>>
            <?php if ($introarticle instanceof \pachno\core\entities\Article): ?>
            ...
            <?php foreach ($issuetypes as $issuetype): ?>
                ...
                <a class="button button-report-issue" data-key="<?= $issuetype->getKey(); ?>" data-id="<?= $issuetype->getID(); ?>" href="javascript:void(0);">
    ...
    <?php if (count($issuetypes) > 0): ?>
        ...
        <?php endif; ?>
        <div id="report_more_here"<?php if ($selected_issuetype instanceof \pachno\core\entities\Issuetype && $selected_project instanceof \pachno\core\entities\Project): ?> style="display: none;"<?php endif; ?>>
            <span id="issuetype_description_help"><?= __("Hold your mouse over an issuetype to see what it's used for"); ?></span>
        </div>
        <div class="report_form" id="report_form"<?php if (!$selected_project instanceof \pachno\core\entities\Project || !$selected_issuetype instanceof \pachno\core\entities\Issuetype): ?> style="display: none;"<?php endif; ?>>
            <?php if ($reporthelparticle instanceof \pachno\core\entities\Article): ?>
            ...
            <table cellpadding="0" cellspacing="0" style="margin-top: 10px;">
                <tr>
                    ...
                    <td style="text-align: left;">
                        ...
                        <?php endif; ?>
                        <select name="issuetype_id" id="issuetype_id<?php if (isset($locked_issuetype) && $locked_issuetype) echo '_fake'; ?>" style="min-width: 300px; height: 25px;" onchange="Pachno.Issues.updateFields('<?= make_url('getreportissuefields', array('project_key' => $selected_project->getKey())); ?>');" <?php if (isset($locked_issuetype) && $locked_issuetype) echo 'disabled'; ?>>
                            <option value="0"><?= __('Please select an issue type from this list'); ?>...</option>
                            <?php foreach ($issuetypes as $issuetype): ?>
                                <?php if (!$selected_project->getIssuetypeScheme()->isIssuetypeReportable($issuetype) && !$pachno_request->isAjaxCall()) continue; ?>
                                <option value="<?= $issuetype->getID(); ?>"<?php if ($selected_issuetype instanceof \pachno\core\entities\Issuetype && $selected_issuetype->getID() == $issuetype->getID()): ?> selected<?php endif; ?>><?= $issuetype->getName(); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" id="description_div" style="display: none; margin-top: 15px;"<?php if (array_key_exists('description', $errors)): ?> class="reportissue_error"<?php endif; ?>>
                ...
                <tr>
                    <td colspan="2" style="padding-top: 5px;" class="editor_container">
                        <?php include_component('main/textarea', array('area_name' => 'description', 'target_type' => 'project', 'target_id' => $selected_project->getID(), 'height' => '300px', 'width' => '990px', 'syntax' => $pachno_user->getPreferredIssuesSyntax(true), 'value' => ((isset($selected_description)) ? $selected_description : null))); ?>
                    </td>
                </tr>
            </table>
            <table cellpadding="0" cellspacing="0" id="reproduction_steps_div" style="display: none; margin-top: 15px;"<?php if (array_key_exists('reproduction_steps', $errors)): ?> class="reportissue_error"<?php endif; ?>>
                ...
                <tr>
                    <td colspan="2" style="padding-top: 5px;" class="editor_container">
                        <?php include_component('textarea', array('area_name' => 'reproduction_steps', 'target_type' => 'project', 'target_id' => $selected_project->getID(), 'height' => '300px', 'width' => '990px', 'syntax' => $pachno_user->getPreferredIssuesSyntax(true), 'value' => ((isset($selected_reproduction_steps)) ? $selected_reproduction_steps : null))); ?>
                    </td>
                </tr>
            </table>
            <?php if ($canupload): ?>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="edition_id" id="edition_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_edition instanceof \pachno\core\entities\Edition) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php if ($selected_edition instanceof \pachno\core\entities\Edition): ?>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="build_id" id="build_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_build instanceof \pachno\core\entities\Build) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php if ($selected_build instanceof \pachno\core\entities\Build): ?>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="component_id" id="component_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_component instanceof \pachno\core\entities\Component) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php if ($selected_component instanceof \pachno\core\entities\Component): ?>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="status_id" id="status_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_status instanceof \pachno\core\entities\Status) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($statuses as $status): ?>
                                    <option value="<?= $status->getID(); ?>"<?php if ($selected_status instanceof \pachno\core\entities\Status && $selected_status->getID() == $status->getID()): ?> selected<?php endif; ?>><?= $status->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="category_id" id="category_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_category instanceof \pachno\core\entities\Category) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($categories as $category): ?>
                                    <?php if (!$category->hasAccess()) continue; ?>
                                    <option value="<?= $category->getID(); ?>"<?php if ($selected_category instanceof \pachno\core\entities\Category && $selected_category->getID() == $category->getID()): ?> selected<?php endif; ?>><?= $category->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="resolution_id" id="resolution_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_resolution instanceof \pachno\core\entities\Resolution) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($resolutions as $resolution): ?>
                                    <option value="<?= $resolution->getID(); ?>"<?php if ($selected_resolution instanceof \pachno\core\entities\Resolution && $selected_resolution->getID() == $resolution->getID()): ?> selected<?php endif; ?>><?= $resolution->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="reproducability_id" id="reproducability_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_reproducability instanceof \pachno\core\entities\Reproducability) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($reproducabilities as $reproducability): ?>
                                    <option value="<?= $reproducability->getID(); ?>"<?php if ($selected_reproducability instanceof \pachno\core\entities\Reproducability && $selected_reproducability->getID() == $reproducability->getID()): ?> selected<?php endif; ?>><?= $reproducability->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="priority_id" id="priority_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_priority instanceof \pachno\core\entities\Priority) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($priorities as $priority): ?>
                                    <option value="<?= $priority->getID(); ?>"<?php if ($selected_priority instanceof \pachno\core\entities\Priority && $selected_priority->getID() == $priority->getID()): ?> selected<?php endif; ?>><?= $priority->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                        ...
                        <tr>
                            <td colspan="2" style="padding-top: 5px;">
                                <select name="milestone_id" id="milestone_id" style="width: 100%;">
                                    <option value=""<?php if (!$selected_milestone instanceof \pachno\core\entities\Milestone) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                    <?php foreach ($milestones as $milestone): ?>
                                        <?php if ($milestone->isClosed()) continue; ?>
                                        <option value="<?= $milestone->getID(); ?>"<?php if ($selected_milestone instanceof \pachno\core\entities\Milestone && $selected_milestone->getID() == $milestone->getID()): ?> selected<?php endif; ?>><?= $milestone->getName(); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td colspan="2" style="padding-top: 5px;">
                            <select name="severity_id" id="severity_id" style="width: 100%;">
                                <option value=""<?php if (!$selected_severity instanceof \pachno\core\entities\Severity) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                <?php foreach ($severities as $severity): ?>
                                    <option value="<?= $severity->getID(); ?>"<?php if ($selected_severity instanceof \pachno\core\entities\Severity && $selected_severity->getID() == $severity->getID()): ?> selected<?php endif; ?>><?= $severity->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                </table>
                <?php foreach (\pachno\core\entities\CustomDatatype::getAll() as $field => $customdatatype): ?>
                    <table cellpadding="0" cellspacing="0" id="<?= $customdatatype->getKey(); ?>_div" style="display: none;" class="additional_information<?php if (array_key_exists($customdatatype->getKey(), $errors)): ?> reportissue_error<?php endif; ?>">
                        <tr>
                            <?php if ($customdatatype->getType() == \pachno\core\entities\CustomDatatype::DATE_PICKER || $customdatatype->getType() == \pachno\core\entities\CustomDatatype::DATETIME_PICKER): ?>
                                ...
                                <td style="width: 326px;position: relative;" class="report_issue_help faded_out dark">
                                    ...
                                    <ul class="popup_box more_actions_dropdown" id="<?= $customdatatype->getKey(); ?>_change">
                                        ...
                                        <?php if ($customdatatype->getType() == \pachno\core\entities\CustomDatatype::DATETIME_PICKER): ?>
                                            <li class="nohover">
                                                <label><?= __('Time'); ?></label>
                                    ...
                                    switch ($customdatatype->getType())
                                    {
                                        case \pachno\core\entities\CustomDatatype::DROPDOWN_CHOICE_TEXT: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\CustomDatatypeOption) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php foreach ($customdatatype->getOptions() as $option): ?>
                                                <option value="<?= $option->getID(); ?>"<?php if ($selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\CustomDatatypeOption && $selected_customdatatype[$customdatatype->getKey()]->getID() == $option->getID()): ?> selected<?php endif; ?>><?= $option->getName(); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php
                                            break;
                                        case \pachno\core\entities\CustomDatatype::EDITIONS_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Edition) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php if ($selected_project instanceof \pachno\core\entities\Project): ?>
                                        ...
                                        case \pachno\core\entities\CustomDatatype::STATUS_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Status) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php foreach (\pachno\core\entities\Status::getAll() as $option): ?>
                                                    <option value="<?= $option->getID(); ?>"<?php if ($selected_customdatatype[$customdatatype->getKey()] == $option->getID()): ?> selected<?php endif; ?>><?= $option->getName(); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php
                                        ...
                                        case \pachno\core\entities\CustomDatatype::TEAM_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Team) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php foreach (\pachno\core\entities\Team::getAll() as $option): ?>
                                                    <option value="<?= $option->getID(); ?>"<?php if ($selected_customdatatype[$customdatatype->getKey()] == $option->getID()): ?> selected<?php endif; ?>><?= $option->getName(); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php
                                        ...
                                        case \pachno\core\entities\CustomDatatype::CLIENT_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Client) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php foreach (\pachno\core\entities\Client::getAll() as $option): ?>
                                                    <option value="<?= $option->getID(); ?>"<?php if ($selected_customdatatype[$customdatatype->getKey()] == $option->getID()): ?> selected<?php endif; ?>><?= $option->getName(); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <?php
                                        ...
                                        case \pachno\core\entities\CustomDatatype::COMPONENTS_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Component) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php if ($selected_project instanceof \pachno\core\entities\Project): ?>
                                        ...
                                        case \pachno\core\entities\CustomDatatype::RELEASES_CHOICE: ?>
                                            <select name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_id" style="width: 100%;">
                                                <option value=""<?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\Build) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                                <?php if ($selected_project instanceof \pachno\core\entities\Project): ?>
                                        ...
                                        case \pachno\core\entities\CustomDatatype::RADIO_CHOICE: ?>
                                            <input type="radio" name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_0" value="" <?php if (!$selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\CustomDatatypeOption): ?> selected<?php endif; ?> /> <label for="<?= $customdatatype->getKey(); ?>_0"><?= __('Not specified'); ?></label><br>
                                            <?php foreach ($customdatatype->getOptions() as $option): ?>
                                                <input type="radio" name="<?= $customdatatype->getKey(); ?>_id" id="<?= $customdatatype->getKey(); ?>_<?= $option->getID(); ?>" value="<?= $option->getID(); ?>" <?php if ($selected_customdatatype[$customdatatype->getKey()] instanceof \pachno\core\entities\CustomDatatypeOption && $selected_customdatatype[$customdatatype->getKey()]->getID() == $option->getID()): ?> selected<?php endif; ?> /> <label for="<?= $customdatatype->getKey(); ?>_<?= $option->getID(); ?>"><?= $option->getName(); ?></label><br>
                                            <?php endforeach; ?>
                                            <?php
                                            break;
            ...
            <?php endif; ?>
            <?php \pachno\core\framework\Event::createNew('core', 'reportissue.prefile')->trigger(); ?>
            <?php if ($selected_project instanceof \pachno\core\entities\Project && $selected_project->permissionCheck('canlockandeditlockedissues')): ?>
                <div class="report-issue-custom-access-check">
                    <?= fa_image_tag('user-lock'); ?>
                    <input type="checkbox" name="custom_issue_access" id="report-issue-custom-access-checkbox" class="fancycheckbox" onchange="Pachno.Issues.ACL.toggle_custom_access(this);" value="1"><label for="report-issue-custom-access-checkbox"><?= fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('Custom access policy'); ?></label>
                    <div class="report-issue-custom-access-container" style="display:none;">
                        <input type="radio" name="issue_access" id="issue_access_public" onchange="Pachno.Issues.ACL.toggle_checkboxes(this, '', 'public');" value="public"<?php if ($selected_project->getIssuesLockType() === \pachno\core\entities\Project::ISSUES_LOCK_TYPE_PUBLIC) echo ' checked'; ?>><label for="issue_access_public"><?= __('Available to anyone with access to project'); ?></label><br>
                        <input type="radio" name="issue_access" id="issue_access_public_category" onchange="Pachno.Issues.ACL.toggle_checkboxes(this, '', 'public_category');" value="public_category"<?php if ($selected_project->getIssuesLockType() === \pachno\core\entities\Project::ISSUES_LOCK_TYPE_PUBLIC_CATEGORY) echo ' checked'; ?>><label for="issue_access_public_category"><?= __('Available to anyone with access to project, category and those listed below'); ?></label><br>
                        <input type="radio" name="issue_access" id="issue_access_restricted" onchange="Pachno.Issues.ACL.toggle_checkboxes(this, '', 'restricted');" value="restricted"<?php if ($selected_project->getIssuesLockType() === \pachno\core\entities\Project::ISSUES_LOCK_TYPE_RESTRICTED) echo ' checked'; ?>><label for="issue_access_restricted"><?= __('Available only to you and those listed below'); ?></label><br>
                        <script>
            ...
            <div class="rounded_box report_issue_submit_container report_issue_desc green borderless">
                ...
                <input type="submit" class="button" value="<?= __('File issue'); ?>" id="report_issue_submit_button">
            ...
            <div class="rounded_box report_issue_desc borderless lightgrey" id="report_issue_add_extra" style="vertical-align: middle; padding: 5px;">
                ...
                <ul id="reportissue_extrafields">
                    <li id="status_additional" style="display: none;">
                        ...
                        <div id="status_link"<?php if ($selected_status instanceof \pachno\core\entities\Status): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('status_link').hide();$('status_additional_div').show();"><?= __('Set initial status'); ?></a></div>
                        <div id="status_additional_div"<?php if ($selected_status === null): ?> style="display: none;"<?php endif; ?>>
                            <select name="status_id" id="status_id_additional">
                                ...
                                <?php foreach ($statuses as $status): ?>
                                    <option value="<?= $status->getID(); ?>"<?php if ($selected_status instanceof \pachno\core\entities\Datatype && $selected_status->getID() == $status->getID()): ?> selected<?php endif; ?>><?= $status->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <li id="edition_additional" style="display: none;">
                        ...
                        <div id="edition_link"<?php if ($selected_edition instanceof \pachno\core\entities\Edition): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('edition_link').hide();$('edition_additional_div').show();"><?= __('Specify edition'); ?></a></div>
                    ...
                    <li id="build_additional" style="display: none;">
                        ...
                        <div id="build_link"<?php if ($selected_build instanceof \pachno\core\entities\Build): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('build_link').hide();$('build_additional_div').show();"><?= __('Specify release'); ?></a></div>
                    ...
                    <li id="component_additional" style="display: none;">
                        ...
                        <div id="component_link"<?php if ($selected_component instanceof \pachno\core\entities\Component): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('component_link').hide();$('component_additional_div').show();"><?= __('Specify component'); ?></a></div>
                    ...
                    <?php if (!isset($selected_milestone)): ?>
                        <li id="milestone_additional" style="display: none;">
                            ...
                            <div id="milestone_link"<?php if ($selected_milestone instanceof \pachno\core\entities\Milestone): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('milestone_link').hide();$('milestone_additional_div').show();"><?= __('Specify milestone'); ?></a></div>
                            <div id="milestone_additional_div"<?php if ($selected_milestone === null): ?> style="display: none;"<?php endif; ?>>
                                <select name="milestone_id" id="milestone_id_additional">
                                    <option value=""<?php if (!$selected_milestone instanceof \pachno\core\entities\Milestone) echo ' selected'; ?>><?= __('Not specified'); ?></option>
                                    <?php if ($selected_milestone instanceof \pachno\core\entities\Milestone): ?>
                    ...
                    <li id="category_additional" style="display: none;">
                        ...
                        <div id="category_link"<?php if ($selected_category instanceof \pachno\core\entities\Category): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('category_link').hide();$('category_additional_div').show();"><?= __('Specify category'); ?></a></div>
                        <div id="category_additional_div"<?php if ($selected_category === null): ?> style="display: none;"<?php endif; ?>>
                            <select name="category_id" id="category_id_additional">
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <?php if (!$category->hasAccess()) continue; ?>
                                    <option value="<?= $category->getID(); ?>"<?php if ($selected_category instanceof \pachno\core\entities\Datatype && $selected_category->getID() == $category->getID()): ?> selected<?php endif; ?>><?= $category->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <li id="priority_additional" style="display: none;">
                        ...
                        <div id="priority_link"<?php if ($selected_priority instanceof \pachno\core\entities\Priority): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('priority_link').hide();$('priority_additional_div').show();"><?= __('Set priority'); ?></a></div>
                    ...
                    <li id="reproducability_additional" style="display: none;">
                        ...
                        <div id="reproducability_link"<?php if ($selected_reproducability instanceof \pachno\core\entities\Reproducability): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('reproducability_link').hide();$('reproducability_additional_div').show();"><?= __('Set reproducability'); ?></a></div>
                        <div id="reproducability_additional_div"<?php if ($selected_reproducability === null): ?> style="display: none;"<?php endif; ?>>
                            <select name="reproducability_id" id="reproducability_id_additional">
                                <option value=""><?= __('Not specified'); ?></option>
                                <?php foreach ($reproducabilities as $reproducability): ?>
                                    <option value="<?= $reproducability->getID(); ?>"<?php if ($selected_reproducability instanceof \pachno\core\entities\Datatype && $selected_reproducability->getID() == $reproducability->getID()): ?> selected<?php endif; ?>><?= $reproducability->getName(); ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <li id="resolution_additional" style="display: none;">
                        ...
                        <div id="resolution_link"<?php if ($selected_resolution instanceof \pachno\core\entities\Resolution): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('resolution_link').hide();$('resolution_additional_div').show();"><?= __('Set resolution'); ?></a></div>
                    ...
                    <li id="severity_additional" style="display: none;">
                        ...
                        <div id="severity_link"<?php if ($selected_severity instanceof \pachno\core\entities\Severity): ?> style="display: none;"<?php endif; ?>><a href="javascript:void(0);" onclick="$('severity_link').hide();$('severity_additional_div').show();"><?= __('Set severity'); ?></a></div>
                    ...
                    <?php foreach (\pachno\core\entities\CustomDatatype::getAll() as $customdatatype): ?>
                    ...
                    <?php endforeach; ?>
                    <?php \pachno\core\framework\Event::createNew('core', 'reportissue.listfields')->trigger(); ?>
                </ul>
                <div style="clear: both;"> </div>
            </div>
        </div>
