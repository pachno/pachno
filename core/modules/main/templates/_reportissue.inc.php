...
<?php if (!empty($errors) || !(empty($permission_errors))): ?>
    <div class="message-box type-error">
        <div class="message">
            <p><?= __('One or more errors occured when trying to file your issue'); ?></p>
            <ul>
            ...
            <p><?= __('Please try to fix the error described above, and then click the %file_issue button again', array('%file_issue' => '<b>'.__('File issue').'</b>')); ?></p>
        </div>
    </div>
...
<div class="form-container">
    <form action="<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey())); ?>" method="post" accept-charset="<?= \pachno\core\framework\Context::getI18n()->getCharset(); ?>" <?php if ($pachno_request->isAjaxCall()): ?>onsubmit="Pachno.Main.submitIssue('<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey(), 'return_format' => 'planning')); ?>');return false;" id="report_issue_form" style="<?php if (isset($issue) && $issue instanceof \pachno\core\entities\Issue) echo 'display: none;'; ?>"<?php endif; ?>>
        ...
        <?php if (count($issuetypes) > 0): ?>
            <div class="form-row" id="issuetype_list" <?php if ($selected_issuetype instanceof \pachno\core\entities\Issuetype) echo 'style="display: none;"'; ?>>
                <div class="list-mode">
        ...
        <?php if (count($issuetypes) > 0): ?>
            ...
            <?php $reproduction_steps = $reproduction_steps ?? ''; ?>
            <div id="report_more_here" class="form-row" <?php if ($selected_issuetype instanceof \pachno\core\entities\Issuetype && $selected_project instanceof \pachno\core\entities\Project): ?> style="display: none;"<?php endif; ?>>
