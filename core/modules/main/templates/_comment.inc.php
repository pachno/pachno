<?php if ($comment->isReply()): ?>
    <div class="comment reply <?php if (!$comment->isPublic()): ?> private_comment<?php endif; ?> syntax_<?= \pachno\core\framework\Settings::getSyntaxClass($comment->getSyntax()); ?>" id="comment_<?= $comment->getID(); ?>">
