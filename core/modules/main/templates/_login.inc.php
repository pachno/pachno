...
<?php if (\pachno\core\framework\Settings::isRegistrationAllowed()): ?>
    <div style="text-align: center;" id="registration-button-container" class="logindiv form-container login_button_container registration_button_container active">
        ...
        <a href="javascript:void(0);" class="button secondary highlight" id="create-account-button" onclick="$('register').addClassName('active');$('registration-button-container').removeClassName('active');$('regular_login_container').removeClassName('active');"><?= __('Create an account'); ?></a>
    </div>
