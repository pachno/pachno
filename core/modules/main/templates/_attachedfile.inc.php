    ...
    <li id="<?php echo $base_id . '_' . $file_id; ?>" class="attached_item <?php if ($file->isImage()) echo 'file_image'; ?>">
        <?php if ($file->isImage()): ?>
            ...
            <div class="embedlink removelink">
                <?php echo javascript_link_tag(image_tag('action_embed.png'), array('onclick' => "Pachno.Main.Helpers.Dialog.showModal('".__('Embedding this file in descriptions or comments')."', '".__('Use this tag to include this image: [[Image:%filename|thumb|Image description]]', array('%filename' => $file->getRealFilename()))."');")); ?>
            </div>
        <?php else: ?>
