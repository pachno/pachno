 ...
 */
    ...
    $comment_id = (isset($comment) && $comment instanceof \pachno\core\entities\Comment) ? $comment->getId() : 0;
...
<li class="todo" id="item_option_<?php echo $todo_key; ?>" style="clear: both;">
    <div id="item_option_<?php echo $todo_key; ?>_content">
          ...
          <?php echo image_tag('spinning_16.gif', [
            ...
            <?php if ($todo['closed']): ?>
                <a href="javascript:void(0);"
                   onclick="Pachno.Issues.markTodo(
        ...
        <span id="<?php echo $todo_key; ?>_name"><?php echo \pachno\core\helpers\TextParser::parseText($todo['text']); ?></span>
