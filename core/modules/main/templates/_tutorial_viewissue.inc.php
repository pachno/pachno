<script>
    require(['domReady', 'pachno/index'], function (domReady, Pachno) {
        Pachno.Tutorial.Stories.viewissue = {
            1: {
            ...
            2: {
                ...
                message: "<h3><?php echo __('Getting help'); ?></h3><?php echo __("Remember that you can always get help on any page in Pachno by clicking '%help_for_this_page' in the user menu.", array('%help_for_this_page' => __('Help for this page'))).'<br>'.__("This will take you to the online help page for the specific page you are on."); ?>",
                messageSize: 'large',
            ...
            11: {
                message: "<h3><?php echo __('Good to go!'); ?></h3><?php echo __("That's all for this tutorial. Don't forget that you can always get help for any page by using the 'Help' menu entry in your user menu at the top right corner."); ?><br><br><?php echo __('Have fun using Pachno!'); ?>",
                messageSize: 'large',
                messagePosition: 'center',
                button: '<?php echo __("I most certainly will!"); ?>'
            }
        };
        Pachno.Tutorial.start('viewissue');
    });
</script>
