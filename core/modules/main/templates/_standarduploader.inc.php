<?php $apc_enabled = \pachno\core\framework\Request::CanGetUploadStatus(); ?>
<div id="backdrop_detail_content" class="backdrop_detail_content">
    <div id="upload_forms">
        <form method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" id="uploader_upload_form" style="margin: 10px 0 0 5px;<?php if ($apc_enabled): ?> display: none;<?php endif; ?>">
            <input type="hidden" name ="MAX_FILE_SIZE" value="<?php echo \pachno\core\framework\Settings::getUploadsEffectiveMaxSize(true); ?>">
            ...
            <div>
                <dl>
                    ...
                    <?php $max_filesize = \pachno\core\framework\Settings::getUploadsEffectiveMaxSize();
                    if($max_filesize != 0):?>
