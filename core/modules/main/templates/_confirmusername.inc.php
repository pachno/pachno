<div class="backdrop_box large" id="username_confirmation_popup">
    ...
    <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('account_pick_username', array('selected_username' => $username)); ?>" method="post" id="pick_username_form">
        <div class="backdrop_details_submit">
            <span class="explanation"></span>
            <div class="submit_container">
                <input type="submit" value="<?php echo __('Yes'); ?>" class="button">
            </div>
        </div>
    </form>
</div>
