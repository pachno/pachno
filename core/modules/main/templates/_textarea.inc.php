<?php
    ...
    {
        $syntax = \pachno\core\framework\Settings::getSyntaxClass(\pachno\core\framework\Settings::SYNTAX_MD);
    }
...
<div class="textarea_container syntax_<?php echo $syntax; ?>">
    <div class="syntax_picker_container">
        <input type="hidden" id="<?php echo $base_id; ?>_syntax" name="<?php echo $area_name; ?>_syntax" value="<?php echo \pachno\core\framework\Settings::getSyntaxValue($syntax); ?>">
        <a id="<?php echo $base_id; ?>_toggle_syntax_button" class="button syntax_picker dropper"><?php echo __('Selected syntax: %selected_syntax', array('%selected_syntax' => '<span id="'.$base_id.'_selected_syntax">'.$syntaxname.'</span>')); ?>&nbsp;&nbsp;<?= fa_image_tag('angle-down'); ?></a>
        <ul id="<?php echo $base_id; ?>_syntax_picker" class="rounded_box white shadowed more_actions_dropdown popup_box" onclick="$(this).previous().toggleClassName('button-pressed');Pachno.Main.Profile.clearPopupsAndButtons();">
            <li class="mw <?php if ($syntax == 'mw') echo 'selected'; ?>" data-syntax-name="<?php echo __('Mediawiki'); ?>"><a href="javascript:void(0);" onclick="Pachno.Main.Helpers.setSyntax('<?php echo $base_id; ?>', 'mw');"><?php echo __('Mediawiki syntax'); ?></a></li>
            <li class="md <?php if ($syntax == 'md') echo 'selected'; ?>" data-syntax-name="<?php echo __('Markdown'); ?>"><a href="javascript:void(0);" onclick="Pachno.Main.Helpers.setSyntax('<?php echo $base_id; ?>', 'md');"><?php echo __('Markdown syntax'); ?></a></li>
            <li class="pt <?php if ($syntax == 'pt') echo 'selected'; ?>" data-syntax-name="<?php echo __('Plaintext'); ?>"><a href="javascript:void(0);" onclick="Pachno.Main.Helpers.setSyntax('<?php echo $base_id; ?>', 'pt');"><?php echo __('Plain text'); ?></a></li>
        </ul>
    </div>
    ...
    <?php if (!isset($hide_hint) || $hide_hint == false): ?>
        <div class="textarea_hint">
            <p class="syntax_pt_hint hint_container">
                ...
                ?><br>
                <?php echo __('See more formatting tips in %markdown_formatting.', array('%markdown_formatting' => '<a href="https://projects.pachno.com/pachno/docs/MarkdownFormatting" target="_new" tabindex="-1">MarkdownFormatting</a>')); ?>
            </p>
                ...
                <?php
                    ...
                    switch (rand(1, 6))
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            echo __('Code samples are best presented between two "~~~~"-lines.') . ' ' . __('Pachno can automatically apply syntax highlighting with support for over 100 languages!');
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            echo __('Pachno uses an enhanced flavor of the markdown syntax, which makes each newline count. If you want to add a linebreak, add a new line and it will be presented just like you type.');
                            break;
                    }
                ...
                <?php
                    ...
                    switch (rand(1, 10))
                    {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            echo __('Code samples are best presented in <source></source> tags.') . ' ' . __('Pachno can automatically apply syntax highlighting with support for over 100 languages!');
                            echo htmlspecialchars(" (<source lang=\"php\"><?php echo \"fu\"; ?></source>)");
                            break;
                        case 6:
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            echo __('Pachno will automatically add new lines when you add two new lines in your text, whereas one new line is used for formatting as you type. To force a new line, use the <br> tag: "There is a new<br>line here".');
                            break;
                        case 10:
