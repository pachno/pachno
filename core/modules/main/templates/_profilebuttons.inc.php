<div class="profile_buttons">
    ...
    <?php if ($pachno_user->isOpenIdLocked()): ?>
        ...
        <div class="rounded_box white shadowed popup_box"  style="top: 23px; z-index: 100; padding: 5px 10px 5px 10px; font-size: 13px; width: 400px;" id="pick_username_div">
            <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('account_check_username'); ?>" onsubmit="Pachno.Main.Profile.checkUsernameAvailability('<?php echo make_url('account_check_username'); ?>'); return false;" method="post" id="check_username_form">
