...
//            }
        ...
        protected function generateXliff($totalFiles, $totalStrings, $stringsByFile)
        {
            ...
            $generatedFile .= "<!-- please visit https://projects.pach.no/pachno/docs/152110/Translating+Pachno -->" . PHP_EOL . PHP_EOL;
            ...
            foreach ($stringsByFile as $file => $strings) {
                ...
                $generatedFile .= '    <file source-language="en-US" datatype="php" original="' . $file . '">' . PHP_EOL;
