<?php
     ...
     * @subpackage core
     */
    class ManageModules extends \pachno\core\framework\cli\Command
    {
        ...
        {
            $this->cliEcho("\nInstalled modules:\n", 'green', 'bold');
            foreach (\pachno\core\framework\Context::getModules() as $module_key => $module)
            {
        ...
        protected function _listAvailable()
        {
            ...
            if (count(\pachno\core\framework\Context::getUninstalledModules()) > 0)
            {
                foreach (\pachno\core\framework\Context::getUninstalledModules() as $module_key => $module)
                {
                    $this->cliEcho("{$module_key}: ", 'white', 'bold');
        ...
        protected function _installModule($module_name)
        {
            ...
            try
            {
                ...
                elseif (\pachno\core\framework\Context::isModuleLoaded($module_name))
                {
                ...
                else
                {
                    ...
                    \pachno\core\entities\Module::installModule($module_name);
        ...
        protected function _uninstallModule($module_name)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    \pachno\core\framework\Context::getModule($module_name)->uninstall();
                    $this->cliEcho(' ok!', 'green', 'bold');
                    $this->cliEcho("\n");
                }
            }
