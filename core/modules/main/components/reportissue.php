...
<div class="form-container hidden" id="report_form" data-fields-url="<?= make_url('getreportissuefields', array('project_key' => $selected_project->getKey())); ?>">
    <form action="<?= make_url('project_reportissue', array('project_key' => $selected_project->getKey(), 'return_format' => 'planning')); ?>" method="post" accept-charset="<?= Context::getI18n()->getCharset(); ?>" id="report_issue_form" data-simple-submit>
        ...
        <?php if (count($issuetypes) > 0): ?>
            ...
            <div class="form-row hidden <?php if (array_key_exists('shortname', $errors)): ?> invalid<?php endif; ?>" id="shortname_div">
            ...
            <div class="row additional-information-container">
                ...
                <?php if (!isset($selected_milestone)): ?>
                    <div class="form-row hidden additional_information <?php if (array_key_exists('milestone', $errors)): ?>invalid<?php endif; ?>" id="milestone_div">
                        <div class="fancy-dropdown-container">
                            <div class="fancy-dropdown" data-default-label="<?= __('Not selected'); ?>">
