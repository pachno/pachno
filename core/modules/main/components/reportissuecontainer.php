<div class="backdrop_box <?php echo isset($medium_backdrop) && $medium_backdrop == 1 ? 'medium' : 'large'; ?>" id="reportissue_container">
    ...
    <div id="backdrop_detail_content" class="backdrop_detail_content with-sidebar sidebar-right">
        <?php include_component('main/reportissue', compact('selected_project', 'issuetypes', 'board', 'selected_statuses', 'selected_priorities', 'selected_categories', 'selected_severities', 'selected_issuetype', 'selected_milestone', 'selected_build', 'parent_issue', 'errors')); ?>
    </div>
</div>
<script>
