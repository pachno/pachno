<li>
    <?php if ($target instanceof \pachno\core\entities\User): ?>
        <input type="hidden" name="access_list_users[<?php echo $target->getID(); ?>]" value="<?php echo $target->getID(); ?>">
        <?php include_component('main/userdropdown', array('user' => $target)); ?>
    ...
    <?php elseif ($target instanceof \pachno\core\entities\Team): ?>
        <input type="hidden" name="access_list_teams[<?php echo $target->getID(); ?>]" value="<?php echo $target->getID(); ?>">
        <?php include_component('main/teamdropdown', array('team' => $target)); ?>
