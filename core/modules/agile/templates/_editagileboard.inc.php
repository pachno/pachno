        ...
        <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('agile_board', array('project_key' => $board->getProject()->getKey(), 'board_id' => $board->getID())); ?>" method="post" id="edit_agileboard_form" onsubmit="Pachno.Project.Planning.saveAgileBoard(this);return false;" data-board-id="<?php echo (int) $board->getId(); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <div class="fancyfilter filter interactive_dropdown" data-filterkey="backlog_search" data-value="<?php echo $board->getTaskIssuetypeID(); ?>" data-no-selection-value="<?php echo __('None selected'); ?>">
                            ...
                            <span class="value"><?php echo ($board->getBacklogSearch() instanceof \pachno\core\entities\SavedSearch) ? $board->getBacklogSearch()->getName() : $autosearches[\pachno\core\entities\SavedSearch::PREDEFINED_SEARCH_PROJECT_OPEN_ISSUES]; ?></span>
                            <div class="interactive_menu">
            ...
            <div class="backdrop_details_submit">
                <div class="submit_container">
                    ...
                    <?php endif; ?>
                    <button class="button" type="submit" id="agileboard_save_button"><?php echo image_tag('spinning_16.gif', ['id' => 'agileboard_edit_indicator', 'style' => 'display: none;']) . __('Save board'); ?></button>
                </div>
            </div>
        </form>
    </div>
