...
<div class="backdrop_box large edit_agileboard">
    ...
    <div id="backdrop_detail_content" class="backdrop_detail_content">
        <div class="form-container">
            <form accept-charset="<?php echo Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('agile_board', ['project_key' => $board->getProject()->getKey(), 'board_id' => $board->getID()]); ?>" method="post" id="edit-agileboard-form" data-interactive-form>
                <div class="form-row">
