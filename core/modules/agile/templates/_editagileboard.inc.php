                        ...
                        <div class="fancy-dropdown-container">
                            <div class="fancy-dropdown">
                                ...
                                <div class="dropdown-container list-mode">
                                    ...
                                    <input type="radio" name="use_swimlane" value="<?= AgileBoard::SWIMLANES_ISSUES; ?>" class="fancy-checkbox" <?php if (!$board->usesSwimlanes()) echo ' checked'; ?> id="agileboard_use_swimlane_<?= $board->getId(); ?>_<?= AgileBoard::SWIMLANES_ISSUES; ?>" onchange="Pachno.Project.Planning.toggleSwimlaneDetails(this);">
                                    ...
                                    <input type="radio" name="use_swimlane" value="<?= AgileBoard::SWIMLANES_GROUPING; ?>" class="fancy-checkbox" <?php if (!$board->usesSwimlanes()) echo ' checked'; ?> id="agileboard_use_swimlane_<?= $board->getId(); ?>_<?= AgileBoard::SWIMLANES_GROUPING; ?>" onchange="Pachno.Project.Planning.toggleSwimlaneDetails(this);">
                                    ...
                                    <input type="radio" name="use_swimlane" value="<?= AgileBoard::SWIMLANES_EXPEDITE; ?>" class="fancy-checkbox" <?php if (!$board->usesSwimlanes()) echo ' checked'; ?> id="agileboard_use_swimlane_<?= $board->getId(); ?>_<?= AgileBoard::SWIMLANES_EXPEDITE; ?>" onchange="Pachno.Project.Planning.toggleSwimlaneDetails(this);">
                    ...
                    <div class="form-row container" id="agileboard-swimlane-details-container">
                        ...
                        <div class="form-row container" id="agileboard_swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_container" style="<?php if (!$board->usesSwimlanes() || $board->getSwimlaneType() != AgileBoard::SWIMLANES_EXPEDITE) echo 'display: none;'; ?>">
                                    ...
                                    <div class="fancy-dropdown" data-default-label="<?php echo __('None selected'); ?>">
                                        ...
                                        <div class="dropdown-container list-mode">
                                            <?php foreach ($swimlane_groups as $value => $description): ?>
                                                ...
                                                <input type="radio" class="fancy-checkbox" name="swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_identifier" value="<?php echo $value; ?>" id="agileboard_swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_identifier_<?= $value; ?>" <?php if ($is_selected) echo 'checked'; ?> onchange="Pachno.Project.Planning.toggleSwimlaneExpediteDetails(this);">
                            ...
                            <div class="form-row" id="agileboard_swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_container_details">
                                <div class="fancy-dropdown-container" id="swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_identifier_priority_values" style="<?php if (!($board->usesSwimlanes() && $board->getSwimlaneType() == AgileBoard::SWIMLANES_EXPEDITE && $board->getSwimlaneIdentifier() == 'priority')) echo 'display: none;'; ?>">
                                ...
                                <div class="fancy-dropdown-container" id="swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_identifier_severity_values" style="<?php if (!($board->usesSwimlanes() && $board->getSwimlaneType() == AgileBoard::SWIMLANES_EXPEDITE && $board->getSwimlaneIdentifier() == 'severity')) echo 'display: none;'; ?>">
                                ...
                                <div class="fancy-dropdown-container" id="swimlane_<?php echo AgileBoard::SWIMLANES_EXPEDITE; ?>_identifier_category_values" style="<?php if (!($board->usesSwimlanes() && $board->getSwimlaneType() == AgileBoard::SWIMLANES_EXPEDITE && $board->getSwimlaneIdentifier() == 'category')) echo 'display: none;'; ?>">
