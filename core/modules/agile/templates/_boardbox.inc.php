...
<a href="<?php echo make_url('agile_whiteboard', array('project_key' => $board->getProject()->getKey(), 'board_id' => $board->getID())); ?>" class="board" id="agileboard_<?php echo $board->getID(); ?>">
    ...
    <div class="actions-container">
        <button class="button secondary icon" onclick="Pachno.Main.Helpers.Backdrop.show('<?php echo make_url('get_partial_for_backdrop', array('key' => 'agileboard', 'project_id' => $board->getProject()->getID(), 'board_id' => $board->getID())); ?>');return false;" title="<?php echo __('Edit this board'); ?>"><?php echo fa_image_tag('cog'); ?></button>
        <button class="button secondary icon" onclick="Pachno.Main.Helpers.Dialog.show('<?php echo __('Delete this board?'); ?>', '<?php echo __('Do you really want to delete this board?').'<br>'.__('Deleting this will make it unavailable. No issues or saved searches will be affected by this action.'); ?>', {yes: {click: function() {Pachno.Project.Planning.removeAgileBoard('<?php echo make_url('agile_board', array('board_id' => $board->getID(), 'project_key' => $board->getProject()->getKey())); ?>');}}, no: {click: Pachno.Main.Helpers.Dialog.dismiss}});return false;" title="<?php echo __('Delete this board'); ?>"><?php echo fa_image_tag('times', ['class' => 'delete']); ?></button>
    </div>
</a>
