...
<a href="<?php echo make_url('agile_whiteboard', array('project_key' => $board->getProject()->getKey(), 'board_id' => $board->getID())); ?>" class="board" id="agileboard_<?php echo $board->getID(); ?>">
    ...
    <div class="actions-container">
        <button class="button secondary icon" onclick="Pachno.UI.Backdrop.show('<?php echo make_url('get_partial_for_backdrop', array('key' => 'agileboard', 'project_id' => $board->getProject()->getID(), 'board_id' => $board->getID())); ?>');return false;" title="<?php echo __('Edit this board'); ?>"><?php echo fa_image_tag('cog'); ?></button>
