<div class="story_color <?php if ($issue->canEditColor()) echo 'dropper'; ?>" title="<?php echo ($issue->canEditColor()) ? __('Click to select a planning color for this issue') : __('Planning color for this issue'); ?>" id="story_color_<?php echo $issue->getID(); ?>" style="background-color: <?php echo $issue->getCoverColor(); ?>;">&nbsp;</div>
