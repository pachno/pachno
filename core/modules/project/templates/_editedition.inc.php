<div class="backdrop_box large">
    ...
    <div id="backdrop_detail_content" class="backdrop_detail_content">
        <div id="editions_menu" class="fancy-tabs">
            ...
            <a class="tab <?php if ($selected_section == 'components') echo 'selected'; ?>" id="edition_components" href="javascript:void(0);" onclick="Pachno.Main.Helpers.tabSwitcher('edition_components', 'editions_menu');">
                <?= fa_image_tag('boxes', ['class' => 'icon']); ?>
                <span class="name"><?= __('Components'); ?></span>
            </a>
            <a class="tab <?php if ($selected_section == 'team') echo 'selected'; ?>" id="edition_team" href="javascript:void(0);" onclick="Pachno.Main.Helpers.tabSwitcher('edition_team', 'editions_menu');">
        ...
        <div id="editions_menu_panes">
                ...
                <table style="width: 780px;" cellpadding=0 cellspacing=0>
                    <tr class="hover_highlight">
                        <td style="padding: 2px; width: 100px;">
                            ...
                            <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                                <?php include_component('main/identifiableselector', array('html_id'        => 'edition_' . $edition->getID() . '_owned_by_change',
                                                                                        ...
                                                                                        'callback'             => "Pachno.Project.setUser('" . make_url('configure_edition_set_leadby', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID(), 'field' => 'owned_by', 'identifiable_type' => '%identifiable_type', 'value' => '%identifiable_value')) . "', 'edition_" . $edition->getID() . "_owned_by');",
                        ...
                        <td style="<?php if (!$edition->hasOwner()): ?>display: none; <?php endif; ?>padding: 2px;" id="edition_<?php echo $edition->getID(); ?>_owned_by_name">
                            <?php if ($edition->getOwner() instanceof \pachno\core\entities\User): ?>
                                <?php echo include_component('main/userdropdown', array('user' => $edition->getOwner())); ?>
                            <?php elseif ($edition->getOwner() instanceof \pachno\core\entities\Team): ?>
                    ...
                    <tr class="hover_highlight">
                        <td style="padding: 2px; width: 100px;">
                            ...
                            <?php include_component('main/identifiableselector', array('html_id'        => 'edition_' . $edition->getID() . '_lead_by_change',
                                                                                    ...
                                                                                    'absolute'            => true,
                                                                                    'style'                => array('position' => 'absolute'),
                                                                                    'callback'             => "Pachno.Project.setUser('" . make_url('configure_edition_set_leadby', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID(), 'field' => 'lead_by', 'identifiable_type' => '%identifiable_type', 'value' => '%identifiable_value')) . "', 'edition_" . $edition->getID() . "_lead_by');",
                        ...
                        <td style="<?php if (!$edition->hasLeader()): ?>display: none; <?php endif; ?>padding: 2px;" id="edition_<?php echo $edition->getID(); ?>_lead_by_name">
                            <?php if ($edition->getLeader() instanceof \pachno\core\entities\User): ?>
                                <?php echo include_component('main/userdropdown', array('user' => $edition->getLeader())); ?>
                            <?php elseif ($edition->getLeader() instanceof \pachno\core\entities\Team): ?>
                    ...
                    <tr class="hover_highlight">
                        <td style="padding: 2px; width: 100px;">
                            ...
                            <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                                <?php include_component('main/identifiableselector', array('html_id'        => 'edition_' . $edition->getID() . '_qa_by_change',
                                                                                        ...
                                                                                        'absolute'            => true,
                                                                                        'style'                => array('position' => 'absolute'),
                                                                                        'callback'             => "Pachno.Project.setUser('" . make_url('configure_edition_set_leadby', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID(), 'field' => 'qa_by', 'identifiable_type' => '%identifiable_type', 'value' => '%identifiable_value')) . "', 'edition_" . $edition->getID() . "_qa_by');",
                        ...
                        <td style="<?php if (!$edition->hasQaResponsible()): ?>display: none; <?php endif; ?>padding: 2px;" id="edition_<?php echo $edition->getID(); ?>_qa_by_name">
                            <?php if ($edition->getQaResponsible() instanceof \pachno\core\entities\User): ?>
                                <?php echo include_component('main/userdropdown', array('user' => $edition->getQaResponsible())); ?>
                            <?php elseif ($edition->getQaResponsible() instanceof \pachno\core\entities\Team): ?>
                        ...
                        <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                            <tr>
                                <td colspan="2" style="padding: 10px 0 10px 10px; text-align: right;">
                                    <div style="float: left; font-size: 13px; padding-top: 2px; font-style: italic;" class="config-explanation"><?php echo __('When you are done, click "%save" to save your changes', array('%save' => __('Save'))); ?></div>
            ...
            <?php if ($edition->getProject()->isComponentsEnabled()): ?>
                ...
                <table style="width: 785px;" cellpadding=0 cellspacing=0>
                    <tr>
                        <td style="<?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?> width: 395px; padding-right: 10px;<?php endif; ?> vertical-align: top;">
                            ...
                            <?php foreach ($edition->getProject()->getComponents() as $aComponent): ?>
                                ...
                                <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                                    <td style="width: 70px; text-align: right;"><a href="javascript:void(0);" onclick="Pachno.Project.Edition.Component.remove('<?php echo make_url('configure_edition_remove_component', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID(), 'component_id' => $aComponent->getID())); ?>', <?php echo $aComponent->getID(); ?>);"><?php echo __('Remove'); ?>&nbsp;&gt;&gt;</a></td>
                                <?php endif; ?>
                                </tr>
                            <?php endforeach; ?>
                    ...
                    <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                        <td style="width: 380px; vertical-align: top; padding-left: 10px;">
                            ...
                            <?php foreach ($edition->getProject()->getComponents() as $aComponent): ?>
                                ...
                                <?php if ($access_level == \pachno\core\framework\Settings::ACCESS_FULL): ?>
                                    <td style="width: 50px; text-align: left;"><a href="javascript:void(0);" onclick="Pachno.Project.Edition.Component.add('<?php echo make_url('configure_edition_add_component', array('project_id' => $edition->getProject()->getID(), 'edition_id' => $edition->getID(), 'component_id' => $aComponent->getID())); ?>', <?php echo $aComponent->getID(); ?>);">&lt;&lt;&nbsp;<?php echo __('Add'); ?></a></td>
                                <?php endif; ?>
                                    <td style="width: 20px; padding: 2px;"><?php echo image_tag('icon_components.png'); ?></td>
                                    <td style="width: auto; padding: 2px;"><?php print $aComponent->getName(); ?></td>
                                </tr>
