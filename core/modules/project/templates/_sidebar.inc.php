    ...
    <div class="list-mode">
        ...
        <?php if ($pachno_response->getPage() == 'project_settings'): ?>
            <div id="project_config_menu">
                <a id="tab_information" href="javascript:void(0);" onclick="Pachno.Main.Helpers.tabSwitcher('tab_information', 'project_config_menu');return false;" class="list-item <?php if ($selected_tab == 'info') echo 'selected'; ?>">
                ...
                <a id="tab_issues_and_workflow" href="javascript:void(0);" onclick="Pachno.Main.Helpers.tabSwitcher('tab_issues_and_workflow', 'project_config_menu');return false;" class="list-item <?php if ($selected_tab == 'issues_and_workflow') echo 'selected'; ?>">
                    <?= fa_image_tag('edit', ['class' => 'icon'], 'far'); ?>
