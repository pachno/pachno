<div class="header <?php if (!$milestone->getID()) echo 'backlog'; ?>" id="milestone_<?php echo $milestone->getID(); ?>_header">
    ...
    <?php if ($include_buttons): ?>
        ...
        <div class="button-group" style="float: right;">
            <?php if ($milestone->getID()): ?>
                <?php echo link_tag(make_url('project_issues', array('project_key' => \pachno\core\framework\Context::getCurrentProject()->getKey(), 'search' => true, 'fs[milestone]' => array('o' => '=', 'v' => $milestone->getId())))."?sortfields=issues.last_updated=asc", __('Show issues'), array('class' => 'button', 'title' => __('Show issues'))); ?>
            <?php endif; ?>
        </div>
    <?php endif; ?>
