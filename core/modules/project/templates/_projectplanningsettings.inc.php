<?php
$selected_columns = $selected_project->getPlanningColumns($pachno_user);
            ...
            <?php if (!$pachno_user->isGuest()): ?>
                <div class="backdrop_details_submit">
                    ...
                    <div class="submit_container">
                        <button type="submit" id="planning_column_settings_save_button" onclick="$('planning_column_settings_indicator').toggle()" class="column_settings_save_button button"><?= image_tag('spinning_16.gif', ['id' => 'planning_column_settings_indicator', 'style' => 'display: none;']) . __('Done') ?></button>
                    </div>
                </div>
            <?php endif; ?>
        </div>
