<li id="show_component_<?php print $component->getID(); ?>" class="hover_highlight">
    ...
    <div class="component_actions">
        <a href="javascript:void(0);" class="button dropper" id="component_<?php echo $component->getID(); ?>_more_actions"><?php echo __('Actions'); ?></a>
        <ul class="simple-list rounded_box white shadowed more_actions_dropdown popup_box" onclick="$('component_<?php echo $component->getID(); ?>_more_actions').toggleClassName('button-pressed');$(this).toggle();">
            <li><?php echo javascript_link_tag(__('Edit'), array('class' => 'image', 'onclick' => "Pachno.Project.Component.edit('".make_url('configure_project_component', array('project_id' => $component->getProject()->getID(), 'component_id' => $component->getID()))."', '".$component->getID()."');", 'title' => __('Edit component'))); ?></li>
