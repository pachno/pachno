<?php
    ...
    $pachno_response->addBreadcrumb(__('Statistics'), make_url('project_statistics', array('project_key' => $selected_project->getKey())));
    $pachno_response->setTitle(__('"%project_name" project team', array('%project_name' => $selected_project->getName())));
    ...
    <div class="project_left_container">
        <div class="project_left">
            ...
            <ul class="simple-list" id="statistics_selector">
                ...
                <li id="statistics_per_status_selector"><a href="javascript:void(0);" onclick="Pachno.Project.Statistics.get('<?php echo make_url('project_statistics_imagesets', array('project_key' => $selected_project->getKey(), 'set' => 'issues_per_status')); ?>', 'status');"><?php echo __('%number_of_issues_per Status type', array('%number_of_issues_per' => '')); ?></a></li>
            </ul>
            ...
            <div style="width: 790px;">
                <div style="display: none;" id="statistics_main">
                    ...
                    <table style="width: 697px; margin-top: 5px;" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td style="width: 33%; height: 150px; padding: 1px;"><img src="#" onclick="Pachno.Project.Statistics.toggleImage(1);" id="statistics_mini_image_1" alt="<?php echo __('Loading, please wait'); ?>" style="cursor: pointer;" title="<?php echo __('Show details'); ?>"></td>
                            <td style="width: 33%; padding: 1px;"><img src="#" onclick="Pachno.Project.Statistics.toggleImage(2);" id="statistics_mini_image_2" alt="<?php echo __('Loading, please wait'); ?>" style="cursor: pointer;" title="<?php echo __('Show details'); ?>"></td>
                            <td style="width: 34%; padding: 1px;"><img src="#" onclick="Pachno.Project.Statistics.toggleImage(3);" id="statistics_mini_image_3" alt="<?php echo __('Loading, please wait'); ?>" style="cursor: pointer;" title="<?php echo __('Show details'); ?>"></td>
                        </tr>
                    </table>
                    ...
                    <?php \pachno\core\framework\Event::createNew('core', 'projectstatistics_image', $selected_project)->trigger(); ?>
                </div>
