...
<?php echo link_tag(make_url('project_statistics', array('project_key' => \pachno\core\framework\Context::getCurrentProject()->getKey())), __('Show more statistics'), array('class' => 'button dash', 'title' => __('More statistics'))); ?>
<?php if ($key != 'workflowstep'): ?>
    <?php echo link_tag(make_url('project_issues', array('project_key' => \pachno\core\framework\Context::getCurrentProject()->getKey(), 'search' => true, 'fs[state]' => array('o' => '=', 'v' => \pachno\core\entities\Issue::STATE_OPEN), 'groupby' => $key, 'grouporder' => 'desc'))."?sortfields=issues.{$key}=asc", __('Show details'), array('class' => 'button dash', 'title' => __('Show more issues'))); ?>
<?php endif; ?>
<br style="clear: both;">
