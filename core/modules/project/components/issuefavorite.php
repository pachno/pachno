...
?>
<div class="toggle-favourite-container">
    ...
    <?php else: ?>
        ...
        <?php include_component('main/favouritetoggle', ['url' => make_url('toggle_favourite_issue', array('issue_id' => $issue->getID(), 'user_id' => $pachno_user->getID())), 'include_user' => false, 'starred' => $pachno_user->isIssueStarred($issue->getID())]); ?>
    <?php endif; ?>
</div>
