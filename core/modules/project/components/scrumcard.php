<li class="story_card moveable" id="scrum_story_<?php echo $issue->getID(); ?>">
    ...
    <div class="story_color" id="story_color_<?php echo $issue->getID(); ?>" <?php if ($issue->canEditIssue()): ?>onclick="$('#color_selector_<?php echo $issue->getID(); ?>').toggle();"<?php endif; ?> style="cursor: pointer; background-color: <?php echo $issue->getCoverColor(); ?>;">&nbsp;</div>
