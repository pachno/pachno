<div id="issue-messages-container" class="messages-container">
    <?php if (isset($error) && $error): ?>
        <div class="message-box type-error" id="viewissue_error">
    ...
    <?php if (isset($issue_saved)): ?>
        <div class="message-box type-info" id="viewissue_saved">
    ...
    <?php endif; ?>
    <div class="message-box type-error" id="blocking_div"<?php if (!$issue->isBlocking()): ?> style="display: none;"<?php endif; ?>>
        <span class="content"><?php echo __('This issue is blocking the next release'); ?></span>
    </div>
    <?php if ($issue->isDuplicate()): ?>
        <div class="message-box type-info" id="viewissue_duplicate">
    ...
    <?php if ($issue->isClosed()): ?>
        <div class="message-box type-info" id="viewissue_closed">
            <?php echo fa_image_tag('info-circle', ['class' => 'icon']); ?>
    ...
    <?php if ($issue->getProject()->isArchived()): ?>
        <div class="message-box type-important" id="viewissue_archived">
