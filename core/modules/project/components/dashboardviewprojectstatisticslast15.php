<?php /* <div style="text-align: center;"><?php echo image_tag(make_url('project_statistics_last_15', array('project_key' => \pachno\core\framework\Context::getCurrentProject()->getKey())), array('style' => 'margin-top: 10px;'), true); ?></div> */ ?>
