<?php
    ...
    class IssueTypes extends ProjectNamespacedController
    {
         ...
         */
        public function runListIssuetypes(framework\Request $request): framework\JsonOutput
        {
            $json = [];
            foreach ($this->selected_project->getIssuetypeScheme()->getIssuetypes() as $issuetype) {
         ...
         * @param framework\Request $request
         */
        public function runListIssuefields(framework\Request $request): framework\JsonOutput
        {
            try {
                ...
                return $this->renderJSON(['error' => 'An error occurred: ' . $e]);
            }
        }
         ...
         * @param framework\Request $request
         */
        public function runListFieldValue(framework\Request $request): framework\JsonOutput
        {
            ...
            switch ($field_key) {
                ...
                case 'activitytype':
                    ...
                    if ($field_key == 'status') {
                        ...
                        $class_prefix = "\\pachno\\core\\entities\\";
