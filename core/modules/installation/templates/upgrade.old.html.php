    ...
    <?php if ($upgrade_available): ?>
        <?php if (version_compare($current_version, '3.2', '<')): ?>
            <div class="rounded_box shadowed padded_box yellow" style="font-size: 1.1em; margin-bottom: 10px;">
                <u>You are performing an update from an older version of Pachno (<?php echo $current_version; ?>), and not 3.2.x or newer</u>.<br>
                This is a valid upgrade, but if you really are upgrading from <?php echo $current_version; ?>, you need to upgrade to the latest 3.2.x release first, and then upgrade to <?php echo \pachno\core\framework\Settings::getVersion(false, true); ?>.
            </div>
        <?php elseif (isset($permissions_ok) && $permissions_ok): ?>
            ...
            <form accept-charset="utf-8" action="<?php echo make_url('upgrade'); ?>" method="post" onsubmit="$('#upgrading_popup').show();">
                <?php if (isset($error)): ?>
                    <div class="padded_box installpage backup" id="install_page_error">
                        ...
                        <div class="progress_buttons">
                            <a href="javascript:void(0);" class="button button-next" onclick="pachno_upgrade_next($(this).up('.installpage'));pachno_upgrade_next($(this).up('.installpage').next());">Okay</a>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="installpage" id="install_page_1">
                    ...
                    Pachno is open source software provided <b>free of charge</b> by zegenie studios - however, none of this would be possible without our great community of dedicated users.<br>
                    ...
                    <ul>
                        ...
                        <li>writing and improving the <a href="https://projects.pach.no/pachno/docs/Main Page">documentation</a></li>
                    ...
                    If you are unable to contribute in any of the ways listed above - but would still like to support us - please send us an email and we'll work something out: <a href="opensource@pachno.com">opensource@pachno.com</a>.<br>
                    <br>
                    <h5>How to get involved in Pachno community:</h5>
                    <a target="_blank" href="http://pachno.com/community">http://pachno.com/community</a> <i>(opens in a new window)</i>
                    <div class="progress_buttons">
                        <a href="javascript:void(0);" class="button button-next" onclick="pachno_upgrade_next($(this).up('.installpage'));">Next</a>
                    </div>
                </div>
                <div class="installpage backup" id="install_page_2">
                    ...
                    <h4 style="margin-bottom: 15px; padding-bottom: 0;">
                        <span style="font-weight: normal;">You are performing the following upgrade: </span><?php echo $current_version; ?>.x <?= fa_image_tag('long-arrow-alt-right'); ?> <?php echo \pachno\core\framework\Settings::getVersion(false, true); ?><br>
                    </h4>
                    ...
                    <div class="progress_buttons">
                        <a href="javascript:void(0);" class="button button-previous" onclick="pachno_upgrade_previous($(this).up('.installpage'));">Previous</a>
                        <a href="javascript:void(0);" class="button button-next" onclick="pachno_upgrade_next($(this).up('.installpage'));">Next</a>
                    </div>
                </div>
                <?php if ($requires_password_reset): ?>
                    <div class="installpage" id="install_page_4">
                        ...
                        <div class="progress_buttons">
                            <a href="javascript:void(0);" class="button button-previous" onclick="pachno_upgrade_previous($(this).up('.installpage'));">Previous</a>
                            <a href="javascript:void(0);" class="button button-next" id="upgrade_password_continue" disabled onclick="pachno_upgrade_next($(this).up('.installpage'));">Next</a>
                        </div>
                    </div>
                    <div class="installpage" id="install_page_5">
                        ...
                        <h2>Almost done</h2>
                        As mentioned on the previous page, this new version of Pachno will make <strong>all current user passwords stop working.</strong><br>
                        ...
                        <div style="clear: both; padding: 30px 0 15px 0; text-align: right;">
                            ...
                            <br>
                            <a href="javascript:void(0);" onclick="pachno_upgrade_previous($(this).up('.installpage'));">&lt;&lt;&nbsp;or go back to change upgrade settings</a>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="installpage" id="install_page_5">
        ...
        <?php else: ?>
            <div class="message-box type-warning with-solution">
                <?= fa_image_tag('exclamation-triangle'); ?>
                <span class="message">
                    The upgrade routine needs the following two files to be writable: <span class="command_box"><?php echo PACHNO_PATH . 'installed'; ?></span> and <span class="command_box"><?php echo PACHNO_PATH . 'upgrade'; ?></span>
                </span>
            </div>
            <div class="message-box type-solution">
                <div class="message">
                    ...
                    <div class="command_box" style="font-size: 1em;">chmod a+w <?php echo PACHNO_PATH . 'installed'; ?> <?php echo PACHNO_PATH . 'upgrade'; ?></div>
                </div>
            </div>
        <?php endif; ?>
