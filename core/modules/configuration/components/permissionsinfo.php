...
<?php endif; ?>
<?= \pachno\core\helpers\TextParser::parseText(__('Please see [[ConfigurePermissions]] for more information about how permissions work in general.', array(), true)); ?><br>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top; padding-right: 5px; box-sizing: border-box;">
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <?php $groups = \pachno\core\entities\Group::getAll(); ?>
            ...
            <td style="width: 50%; vertical-align: top; padding-left: 5px; box-sizing: border-box;">
                <?php $teams = \pachno\core\framework\Context::isProjectContext() ? \pachno\core\framework\Context::getCurrentProject()->getAssignedTeams() : \pachno\core\entities\Team::getAll(); ?>
                <?php if (!count($teams)): ?>
