    ...
    <div style="padding: 5px; position: relative;">
        ...
        <div style="position: absolute; right: 12px; top: 12px;">
            ...
            <ul style="position: absolute; font-size: 1.1em; width: 200px; top: 23px; margin-top: 0; right: 0; text-align: right; z-index: 1000;" class="simple-list rounded_box white shadowed popup_box more_actions_dropdown" onclick="$(this).prev().toggleClass('button-pressed');$(this).toggle();">
                ...
                <li>
                    <?= javascript_link_tag(__('List users in this client'), array('onclick' => 'Pachno.Config.Client.showMembers(\''.make_url('configure_users_get_client_members', array('client_id' => $client->getID())).'\', '.$client->getID().');')); ?>
                </li>
                <li>
        ...
        <?php include_component('main/identifiableselector', array(    'html_id'        => "addmember_client_{$client->getID()}",
                                                                ...
                                                                'callback'             => "Pachno.Config.Client.addMember('".make_url('configure_users_add_client_member', array('client_id' => $client->getID(), 'user_id' => '%identifiable_value'))."', ".$client->getID().", '%identifiable_value');$('#addmember_client_{$client->getID()}').hide();",
