...
<div id="workflow_scheme_<?php echo $scheme->getID(); ?>" class="row" data-workflow-scheme data-id="<?= $scheme->getID(); ?>">
    ...
    <div class="column actions">
        <?php if (isset($embed)): ?>
            <button class="button secondary" onclick="Pachno.Main.Helpers.Backdrop.show('<?= make_url('get_partial_for_backdrop', ['key' => 'edit_workflow_scheme', 'scheme_id' => $scheme->getId()]); ?>');">
