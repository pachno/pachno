<?php
    ...
    if ($step instanceof \pachno\core\entities\WorkflowStep)
    {
        $pachno_response->setTitle(__('Configure workflow step "%step_name"', array('%step_name' => $step->getName())));
...
<table cellpadding=0 cellspacing=0 class="configuration_page">
    <tr>
        <?php include_component('leftmenu', array('selected_section' => \pachno\core\framework\Settings::CONFIGURATION_SECTION_WORKFLOW)); ?>
        <td valign="top" class="main_configuration_content">
            ...
            <div class="content" style="width: 730px;" id="workflow_step_container">
                <?php if ($step instanceof \pachno\core\entities\WorkflowStep): ?>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <select name="state" id="step_state" style="width: 125px;">
                                        <option value="<?php echo \pachno\core\entities\Issue::STATE_OPEN; ?>"<?php if (!$step->isClosed()) echo " selected"; ?>><?php echo __('Open'); ?></option>
                                        <option value="<?php echo \pachno\core\entities\Issue::STATE_CLOSED; ?>"<?php if ($step->isClosed()) echo " selected"; ?>><?php echo __('Closed'); ?></option>
                                    </select>
