    ...
    <form class="row" accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_issuefields_edit', ['type' => $type, 'id' => $item->getID()]); ?>" onsubmit="Pachno.Config.Issuefields.Options.save(this);return false;" data-interactive-form>
        ...
        <div class="icon">
            <?php if ($item->canBeDeleted()): ?>
                <a href="javascript:void(0);" class="button secondary icon" onclick="Pachno.UI.Dialog.show('<?php echo __('Really delete this item?'); ?>', '<?php echo __('Are you really sure you want to delete this item?'); ?>', {yes: {click: function() {Pachno.Config.Issuefields.Options.remove('<?php echo make_url('configure_issuefields_delete', array('type' => $type, 'id' => $item->getID())); ?>', <?php echo $item->getID(); ?>); Pachno.UI.Dialog.dismiss(); }}, no: {click: Pachno.UI.Dialog.dismiss}});"><?php echo fa_image_tag('trash-alt', [], 'far'); ?></a>
            <?php else: ?>
        ...
        <div id="item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content">
            ...
            <div class="button-group" style="float: right;">
                <a href="javascript:void(0);" class="button button-icon" onclick="$('item_option_<?php echo $type; ?>_<?php echo $item->getID(); ?>_content').hide();$('edit_item_option_<?php echo $item->getID(); ?>').show();$('<?php echo $type; ?>_<?php echo $item->getID(); ?>_name_input').focus();" title="<?php echo __('Edit this item'); ?>"><?php echo fa_image_tag('edit'); ?></a>
                ...
                <?php if ($item->canBeDeleted()): ?>
                    <a href="javascript:void(0);" class="button button-icon" onclick="Pachno.UI.Dialog.show('<?php echo __('Really delete %itemname?', array('%itemname' => $item->getName())); ?>', '<?php echo __('Are you really sure you want to delete this item?'); ?>', {yes: {click: function() {Pachno.Config.Issuefields.Options.remove('<?php echo make_url('configure_issuefields_delete', array('type' => $type, 'id' => $item->getID())); ?>', '<?php echo $type; ?>', <?php echo $item->getID(); ?>); Pachno.UI.Dialog.dismiss(); }}, no: {click: Pachno.UI.Dialog.dismiss}});" id="delete_<?php echo $item->getID(); ?>_link"><?php echo fa_image_tag('trash-alt', [], 'far'); ?></a>
                <?php else: ?>
