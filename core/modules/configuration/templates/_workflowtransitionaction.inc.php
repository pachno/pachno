<tr id="workflowtransitionaction_<?php echo $action->getID(); ?>">
    <?php
        ...
        {
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_ASSIGN_ISSUE_SELF:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_ASSIGNEE:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_PRIORITY:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_PERCENT:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_REPRODUCABILITY:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_RESOLUTION:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_MILESTONE:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_DUPLICATE:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_USER_START_WORKING:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_USER_STOP_WORKING:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_MILESTONE:
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_DUPLICATE:
            case \pachno\core\entities\WorkflowTransitionAction::CUSTOMFIELD_CLEAR_PREFIX . $action->getCustomActionType():
                ?>
                <td id="workflowtransitionaction_<?php echo $action->getID(); ?>_description" style="padding: 2px;">
                    <?php if ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_ASSIGN_ISSUE_SELF): ?>
                        <?php echo __('Assign the issue to the current user'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_MILESTONE): ?>
                        <?php echo __('Set milestone to milestone provided by user'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_ASSIGNEE): ?>
                        <?php echo __('Clear issue assignee'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_PRIORITY): ?>
                        <?php echo __('Clear issue priority'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_PERCENT): ?>
                        <?php echo __('Clear issue percent completed'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_REPRODUCABILITY): ?>
                        <?php echo __('Clear issue reproducability'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_RESOLUTION): ?>
                        <?php echo __('Clear issue resolution'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_MILESTONE): ?>
                        <?php echo __('Clear issue milestone'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_USER_START_WORKING): ?>
                        <?php echo __('Start logging time'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_USER_STOP_WORKING): ?>
                        <?php echo __('Stop logging time and optionally add time spent'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_DUPLICATE): ?>
                        <?php echo __('Mark issue as duplicate of another, existing issue'); ?>
                    <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_CLEAR_DUPLICATE): ?>
            ...
            case \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_PERCENT:
            ...
            case \pachno\core\entities\WorkflowTransitionAction::CUSTOMFIELD_SET_PREFIX . $action->getCustomActionType(): ?>
                
                <td id="workflowtransitionaction_<?php echo $action->getID(); ?>_description" style="padding: 2px;">
                    <?php if ($action->hasValidTarget()): ?>
                        <?php if ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_STATUS): ?>
                            <?php
                            ...
                            ?>
                        <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_PRIORITY): ?>
                            <?php echo __('Set priority to %priority', array('%priority' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? \pachno\core\entities\Priority::getB2DBTable()->selectById((int) $action->getTargetValue())->getName() : __('Priority provided by user')) . '</span>')); ?>
                        <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_PERCENT): ?>
                        ...
                        <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_RESOLUTION): ?>
                            <?php echo __('Set resolution to %resolution', array('%resolution' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? \pachno\core\entities\Resolution::getB2DBTable()->selectById((int) $action->getTargetValue())->getName() : __('Resolution provided by user')) . '</span>')); ?>
                        <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_REPRODUCABILITY): ?>
                            <?php echo __('Set reproducability to %reproducability', array('%reproducability' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? \pachno\core\entities\Reproducability::getB2DBTable()->selectById((int) $action->getTargetValue())->getName() : __('Reproducability provided by user')) . '</span>')); ?>
                        <?php elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_ASSIGN_ISSUE): ?>
                            <?php 

                            if ($action->hasTargetValue())
                            {
                                $target_details = explode('_', $action->getTargetValue());
                                echo __('Assign issue to %assignee', array('%assignee' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($target_details[0] == 'user') ? \pachno\core\entities\User::getB2DBTable()->selectById((int) $target_details[1])->getNameWithUsername() : \pachno\core\entities\Team::getB2DBTable()->selectById((int) $target_details[1])->getName()) . '</span>'));
                            }
                            else
                            {
                        ...
                        <?php elseif ($action->isCustomSetAction()): ?>
                            <?php
                            $pachno_response->addJavascript('calendarview.js');

                            switch (\pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType())->getType()) {
                                ...
                                case \pachno\core\entities\CustomDatatype::CALCULATED_FIELD:
                                ...
                                case \pachno\core\entities\CustomDatatype::DATETIME_PICKER:
                                    echo __('Set issue field %key to %value', array('%key' => $action->getCustomActionType(), '%value' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? date('Y-m-d' . (\pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType())->getType() == \pachno\core\entities\CustomDatatype::DATETIME_PICKER ? ' H:i' : ''), (int) $action->getTargetValue()) : __('Value provided by user')) . '</span>'));
                                    break;
                                ...
                                case \pachno\core\entities\CustomDatatype::CLIENT_CHOICE:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\tables\Clients::getTable()->selectById((int) $action->getTargetValue()) : null;
                                ...
                                case \pachno\core\entities\CustomDatatype::RELEASES_CHOICE:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\tables\Builds::getTable()->selectById((int) $action->getTargetValue()) : null;
                                ...
                                case \pachno\core\entities\CustomDatatype::COMPONENTS_CHOICE:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\tables\Components::getTable()->selectById((int) $action->getTargetValue()) : null;
                                    echo __('Set issue field %key to %value', array('%key' => $action->getCustomActionType(), '%value' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? $target->getProject()->getName() . ' - ' . $target->getName() : __('Value provided by user')) . '</span>'));
                                    break;
                                case \pachno\core\entities\CustomDatatype::EDITIONS_CHOICE:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\tables\Editions::getTable()->selectById((int) $action->getTargetValue()) : null;
                                    echo __('Set issue field %key to %value', array('%key' => $action->getCustomActionType(), '%value' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? $target->getProject()->getName() . ' - ' . $target->getName() : __('Value provided by user')) . '</span>'));
                                    break;
                                case \pachno\core\entities\CustomDatatype::MILESTONE_CHOICE:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\tables\Milestones::getTable()->selectById((int) $action->getTargetValue()) : null;
                                    echo __('Set issue field %key to %value', array('%key' => $action->getCustomActionType(), '%value' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? $target->getProject()->getName() . ' - ' . $target->getName() : __('Value provided by user')) . '</span>'));
                                    break;
                                ...
                                default:
                                    $target = ($action->getTargetValue()) ? \pachno\core\entities\CustomDatatypeOption::getB2DBTable()->selectById((int) $action->getTargetValue()) : null;
                                    echo __('Set issue field %key to %value', array('%key' => $action->getCustomActionType(), '%value' => '<span id="workflowtransitionaction_'.$action->getID().'_value" style="font-weight: bold;">' . (($action->getTargetValue()) ? $target->getName() : __('Value provided by user')) . '</span>'));
                                    break;
                            }
                            ?>
                ...
                <?php if (! ($action->isCustomSetAction() && in_array(\pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType())->getType(), array(\pachno\core\entities\CustomDatatype::USER_CHOICE, \pachno\core\entities\CustomDatatype::TEAM_CHOICE, \pachno\core\entities\CustomDatatype::CLIENT_CHOICE)))): ?>
                    <td id="workflowtransitionaction_<?php echo $action->getID(); ?>_edit" style="display: none; padding: 2px;">
                        <form action="<?php echo make_url('configure_workflow_transition_action_post', array('workflow_id' => $action->getWorkflow()->getID(), 'transition_id' => $action->getTransition()->getID(), 'action_id' => $action->getID())); ?>" onsubmit="Pachno.Config.Workflows.Transition.Actions.update('<?php echo make_url('configure_workflow_transition_action_post', array('workflow_id' => $action->getWorkflow()->getID(), 'transition_id' => $action->getTransition()->getID(), 'action_id' => $action->getID())); ?>', <?php echo $action->getID(); ?>);return false;" id="workflowtransitionaction_<?php echo $action->getID(); ?>_form">
                            ...
                            <?php
                                ...
                                if ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_STATUS)
                                    $options = \pachno\core\entities\Status::getAll();
                                elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_PRIORITY)
                                    $options = \pachno\core\entities\Priority::getAll();
                                elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_PERCENT)
                                    $options = range(1, 100);
                                elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_RESOLUTION)
                                    $options = \pachno\core\entities\Resolution::getAll();
                                elseif ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_SET_REPRODUCABILITY)
                                    $options = \pachno\core\entities\Reproducability::getAll();
                                elseif ($action->isCustomAction()) {
                                    $customfield = \pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType());
                                    if ($customfield->getType() == \pachno\core\entities\CustomDatatype::CALCULATED_FIELD) {
                                        $options = array();
                                    } else {
                            ...
                            <?php if (isset($options) && count($options)): ?>
                                <select id="workflowtransitionaction_<?php echo $action->getID(); ?>_input" name="target_value">
                                    ...
                                    <?php if ($action->getActionType() == \pachno\core\entities\WorkflowTransitionAction::ACTION_ASSIGN_ISSUE): ?>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ((isset($options) ? $options : array()) as $option): ?>
                                            <option value="<?php echo ($option instanceof \pachno\core\entities\common\Identifiable) ? $option->getID() : $option; ?>"<?php if (($option instanceof \pachno\core\entities\common\Identifiable && (int) $action->getTargetValue() == $option->getID()) || (!$option instanceof \pachno\core\entities\common\Identifiable && (int) $action->getTargetValue() == $option)) echo ' selected'; ?>>
                            ...
                            <?php else: ?>
                                ...
                                <?php
                                    switch (\pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType())->getType()) {
                                        ...
                                        case \pachno\core\entities\CustomDatatype::DATE_PICKER:
                                        case \pachno\core\entities\CustomDatatype::DATETIME_PICKER: ?>
                                            <input type="hidden" id="workflowtransitionaction_<?php echo $action->getID(); ?>_value_1" name="target_value" value="<?php echo ($action->getTargetValue() ? date('Y-m-d' . (\pachno\core\entities\CustomDatatype::getByKey($action->getCustomActionType())->getType() == \pachno\core\entities\CustomDatatype::DATETIME_PICKER ? ' H:i' : ''), $action->getTargetValue()) : ''); ?>">
    ...
    <td style="width: 100px; text-align: right;">
        <div style="position: relative;">
            <?php if ($show_edit): ?>
                            ...
                            case \pachno\core\entities\CustomDatatype::USER_CHOICE:
                                 echo include_component('main/identifiableselector', array('html_id'        => 'workflowtransitionaction_'. $action->getID().'_edit',
                                                                        'header'          => __('Select a user'),
                                                                            'callback' => "Pachno.Config.Workflows.Transition.Actions.update('". make_url('configure_workflow_transition_action_post', array('workflow_id' => $action->getWorkflow()->getID(), 'transition_id' => $action->getTransition()->getID(), 'action_id' => $action->getID())) ."?target_value=%identifiable_value', '". $action->getID() ."')",
                ...
                <?php endif; ?>
            <?php endif; ?>
            <button id="workflowtransitionaction_<?php echo $action->getID(); ?>_delete_button" onclick="Pachno.Main.Helpers.Dialog.show('<?php echo __('Do you really want to delete this transition action?'); ?>', '<?php echo __('Please confirm that you really want to delete this transition action.'); ?>', {yes: {click: function() {Pachno.Config.Workflows.Transition.Actions.remove('<?php echo make_url('configure_workflow_transition_action_delete', array('workflow_id' => $action->getWorkflow()->getID(), 'transition_id' => $action->getTransition()->getID(), 'action_id' => $action->getID())); ?>', <?php echo $action->getID(); ?>, '<?php echo $action->getActionType(); ?>'); }}, no: { click: Pachno.Main.Helpers.Dialog.dismiss }});"><?php echo __('Delete'); ?></button>
            <?php if ($show_edit): ?>
