        ...
        <td valign="top" class="main_configuration_content">
            <div style="width: 730px;" id="config_scopes">
                ...
                <div class="content faded_out">
                    <p>
                        <?php echo __('Pachno scopes are self-contained environments within the same Pachno installation, set up to be initialized when Pachno is accessed via different hostnames.'); ?>
                    ...
                    <form action="<?php echo make_url('configure_scopes'); ?>" onsubmit="$('add_scope_indicator').show();$('add_scope_submit_button').hide();return true;" method="POST">
                        <div class="content">
                            ...
                            <div class="content faded_out">
                                ...
                                <i>bugs.mycompany.com , internal.company.org , pachno.company.com , dev.company.com:8080</i>
                            </div>
                        </div>
