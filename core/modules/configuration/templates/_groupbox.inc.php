<div class="greybox" style="padding: 0; margin-top: 5px;" id="groupbox_<?php echo $group->getID(); ?>">
    <div style="padding: 5px; position: relative;">
        ...
        <div style="position: absolute; right: 12px; top: 12px;">
            ...
            <ul id="group_<?php echo $group->getID(); ?>_more_actions_dropdown" style="font-size: 1.1em; width: 200px; top: 23px; margin-top: 0; right: 0; text-align: right; z-index: 1000;" class="simple-list rounded_box white shadowed popup_box more_actions_dropdown" onclick="$(this).previous().toggleClassName('button-pressed');$(this).toggle();">
                <li>
                    <?php if ($group->getNumberOfMembers() > 100): ?>
                        <?php echo javascript_link_tag(__('List users in this group'), array('onclick' => "Pachno.Main.Helpers.Dialog.show('".__('This group has a lot of members')."', '".__('Trying to list all users in this group may time out or take a while. Are you sure you want to list all users in this group?')."', {yes: {click: function() {Pachno.Config.Group.showMembers('".make_url('configure_users_get_group_members', array('group_id' => $group->getID()))."', ".$group->getID().");Pachno.Main.Helpers.Dialog.dismiss(); }}, no: { click: Pachno.Main.Helpers.Dialog.dismiss }});")); ?>
                    <?php else: ?>
