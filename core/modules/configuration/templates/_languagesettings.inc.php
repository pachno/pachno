        ...
        <div class="fancy-dropdown">
            ...
            <div class="dropdown-container list-mode">
                <?php foreach ($languages as $language_code => $language): ?>
                    <input type="radio" name="<?php echo \pachno\core\framework\Settings::SETTING_DEFAULT_LANGUAGE; ?>" id="setting_<?php echo \pachno\core\framework\Settings::SETTING_DEFAULT_LANGUAGE; ?>" value="<?php echo $language_code; ?>" <?php if (\pachno\core\framework\Settings::getLanguage() == $language_code): ?> checked<?php endif; ?> class="fancy-checkbox">
...
<div class="form-row">
    ...
    <div class="fancy-dropdown-container">
        <div class="fancy-dropdown">
            ...
            <?= fa_image_tag('angle-down', ['class' => 'expander']); ?>
            <div class="dropdown-container list-mode">
                <input type="radio" name="<?php echo \pachno\core\framework\Settings::SETTING_SERVER_TIMEZONE; ?>" id="setting_<?php echo \pachno\core\framework\Settings::SETTING_SERVER_TIMEZONE; ?>" value="0" <?php if (!\pachno\core\framework\Settings::getServerTimezoneIdentifier()): ?> checked<?php endif; ?> class="fancy-checkbox">
                ...
                <div class="filter_existing_values">
                    <?php foreach ($timezones as $timezone => $description): ?>
                        <input type="radio" name="<?php echo \pachno\core\framework\Settings::SETTING_SERVER_TIMEZONE; ?>" id="setting_<?php echo \pachno\core\framework\Settings::SETTING_SERVER_TIMEZONE; ?>" value="<?php echo $timezone; ?>" <?php if (\pachno\core\framework\Settings::getServerTimezoneIdentifier() == $timezone): ?> checked<?php endif; ?> class="fancy-checkbox">
                        <label for="setting_<?php echo \pachno\core\framework\Settings::SETTING_SERVER_TIMEZONE; ?>" class="list-item">
                            <?= fa_image_tag('check-circle', ['class' => 'checked icon'], 'far') . fa_image_tag('circle', ['class' => 'unchecked icon'], 'far'); ?>
