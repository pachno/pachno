        ...
        <td valign="top" class="main_configuration_content">
            ...
            <div class="content" style="width: 730px;">
                ...
                <div class="lightyellowbox" style="margin-top: 5px;">
                    <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_workflow'); ?>" id="add_workflow_form" method="post">
