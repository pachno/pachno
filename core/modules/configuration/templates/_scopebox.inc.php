    ...
    <div class="content">
        ...
        <?php if ($scope->isDefault() || strlen(trim($scope->getDescription()))): ?>
            <div class="faded_out scope_description">
                ...
                <?php else: ?>
                    <?php echo __('This is the default scope. It will be loaded and used whenever Pachno is accessed on a hostname for which there is not explicit scope defined.'); ?>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
