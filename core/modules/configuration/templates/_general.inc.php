<table style="clear: both; width: 700px; margin-top: 5px;" class="padded_table" cellpadding=0 cellspacing=0>
    <tr>
        <td style="width: 200px;"><label for="b2_name"><?php echo __('Pachno custom name'); ?></label></td>
        <td style="width: auto;">
            <input type="text" name="<?php echo \pachno\core\framework\Settings::SETTING_SITE_NAME; ?>" id="b2_name"
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>" class="fancycheckbox" <?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?> id="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>_yes" value=1<?php if (\pachno\core\framework\Settings::isCommentImagePreviewEnabled()): ?> checked<?php endif; ?>><label for="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>_yes"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('Yes'); ?></label>
            <input type="radio" name="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>" class="fancycheckbox" <?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?> id="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>_no" value=0<?php if (!\pachno\core\framework\Settings::isCommentImagePreviewEnabled()): ?> checked<?php endif; ?>><label for="<?php echo \pachno\core\framework\Settings::SETTING_PREVIEW_COMMENT_IMAGES; ?>_no"><?php echo fa_image_tag('check-square', ['class' => 'checked'], 'far') . fa_image_tag('square', ['class' => 'unchecked'], 'far') . __('No'); ?></label>
            <?php echo config_explanation(
    ...
    <tr>
        ...
        <td>
            <select name="<?php echo \pachno\core\framework\Settings::SETTING_SYNTAX_HIGHLIGHT_DEFAULT_LANGUAGE; ?>" id="highlight_default_lang" style="width: 300px;"<?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?>>
                <?php foreach ($geshi_languages as $lang): ?>
                    <option value=<?php echo $lang; if (\pachno\core\framework\Settings::getDefaultSyntaxHighlightingLanguage() == $lang): ?> selected<?php endif; ?>><?php echo $lang; ?></option>
                <?php endforeach; ?>
            </select>
            <?php echo config_explanation(
    ...
    <tr>
        ...
        <td>
            <select name="<?php echo \pachno\core\framework\Settings::SETTING_SYNTAX_HIGHLIGHT_DEFAULT_NUMBERING; ?>" id="highlight_default_numbering" style="width: 300px;"<?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?>>
                <option value=<?php echo \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_FANCY_NUMBERS; if (\pachno\core\framework\Settings::getDefaultSyntaxHighlightingNumbering() == \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_FANCY_NUMBERS): ?> selected<?php endif; ?>><?php echo __('Fancy numbering, with highlighted lines'); ?></option>
                <option value=<?php echo \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_NORMAL_NUMBERS; if (\pachno\core\framework\Settings::getDefaultSyntaxHighlightingNumbering() == \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_NORMAL_NUMBERS): ?> selected<?php endif; ?>><?php echo __('Normal numbering'); ?></option>
                <option value=<?php echo \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_NO_NUMBERS; if (\pachno\core\framework\Settings::getDefaultSyntaxHighlightingNumbering() == \pachno\core\framework\Settings::SYNTAX_HIHGLIGHTING_NO_NUMBERS): ?> selected<?php endif; ?>><?php echo __('No numbering'); ?></option>
            </select>
            <?php echo config_explanation(
    ...
    <tr>
        ...
        <td>
            <input type="text" name="<?php echo \pachno\core\framework\Settings::SETTING_SYNTAX_HIGHLIGHT_DEFAULT_INTERVAL; ?>" style="width: 50px;"<?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?> id="highlight_default_interval" value="<?php echo (\pachno\core\framework\Settings::get('highlight_default_interval')); ?>" />
            <?php echo config_explanation(
    ...
    <tr>
        ...
        <td>
            <input type="text" name="<?php echo \pachno\core\framework\Settings::SETTING_NOTIFICATION_POLL_INTERVAL; ?>" style="width: 50px;"<?php if ($access_level != \pachno\core\framework\Settings::ACCESS_FULL): ?> disabled<?php endif; ?> id="notification_poll_interval" value="<?php echo (\pachno\core\framework\Settings::getNotificationPollInterval()); ?>" />
            <?php echo config_explanation(
