<?php
    ...
    $pachno_response->setTitle(__('Configure advanced permissions'));
...
<div class="content-with-sidebar">
    ...
    <div class="configuration-container" id="configure_permissions_advanced">
        ...
        <p>
            <?php echo \pachno\core\helpers\TextParser::parseText(__("Edit all global group and team permissions from this page - user-specific permissions are handled from the [[Pachno:configure_users|user configuration page]], and permissions for specific issue fields are available from the [[Pachno:configure_issuefields|issue fields configuration page]].", array(), true)); ?><br>
            <br>
            <?php echo \pachno\core\helpers\TextParser::parseText(__("Pachno permissions are thoroughly explained in [[ConfigurePermissions]] in the wiki - look it up if you're ever stuck.", array(), true)); ?>
        </p>
