<div id="item_<?php echo $type_key; ?>_<?php echo $type->getID(); ?>" class="greybox" style="margin: 5px 0 0 0; position: relative;">
    <div style="position: absolute; right: 5px; top: 30px;">
        ...
        <ul id="<?php echo $type_key; ?>_<?php echo $type->getID(); ?>_more_actions_dropdown" style="font-size: 1.1em; width: 200px; top: 23px; margin-top: 0; text-align: right; z-index: 1000;" class="simple-list rounded_box white shadowed popup_box more_actions_dropdown" onclick="$(this).previous().toggleClassName('button-pressed');$(this).toggle();">
            <li>
