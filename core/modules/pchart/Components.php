<?php
    ...
    namespace pachno\core\modules\pchart;
    ...
    class Components extends \pachno\core\framework\ActionComponent
    {
        ...
        public function componentLineGraph()
        {
            ...
            $Test->setFontProperties(PACHNO_INTERNAL_MODULES_PATH . 'pchart' . DS . 'fonts' . DS . 'OpenSans-Regular.ttf', 8);
            if (isset($this->labels_title))
            {
            ...
            // Draw the 0 line
            $Test->setFontProperties(PACHNO_INTERNAL_MODULES_PATH . 'pchart' . DS . 'fonts' . DS . 'OpenSans-Regular.ttf', 6);
            ...
            $Test->setFontProperties(PACHNO_INTERNAL_MODULES_PATH . 'pchart' . DS . 'fonts' . DS . 'OpenSans-Bold.ttf', 10);
        ...
        public function componentPieChart()
        {
            ...
            $Test->setFontProperties(PACHNO_INTERNAL_MODULES_PATH . 'pchart' . DS . 'fonts' . DS . 'OpenSans-Bold.ttf', $title_font_size);
            $Test->drawTitle(50, 22, $this->title, 50, 50, 50, $this->width - 30);
            $Test->Stroke(); //("example2.png");
        }
