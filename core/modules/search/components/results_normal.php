    ...
    <?php if ($showtablestart): ?>
        <div class="results_body row-container">
            <div class="row header">
                ...
                <?php endif; ?>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::ISSUE_TYPE); ?>" data-sort-field="<?php echo Issues::ISSUE_TYPE; ?>" class="column header sc_issuetype result_issue <?php if ($dir = $search_object->getSortDirection(Issues::ISSUE_TYPE)) echo "sort_{$dir}"; ?>"><?php echo __('Issue'); ?></span></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::ASSIGNEE_USER); ?>" data-sort-field="<?php echo Issues::ASSIGNEE_USER; ?>" class="column header sc_assigned_to <?php if ($dir = $search_object->getSortDirection(Issues::ASSIGNEE_USER)) echo "sort_{$dir}"; ?> <?php if (!in_array('assigned_to', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Assigned to'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::POSTED_BY); ?>" data-sort-field="<?php echo Issues::POSTED_BY; ?>" class="column header sc_posted_by <?php if ($dir = $search_object->getSortDirection(Issues::POSTED_BY)) echo "sort_{$dir}"; ?> <?php if (!in_array('posted_by', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Posted by'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::STATUS); ?>" data-sort-field="<?php echo Issues::STATUS; ?>" class="column header sc_status <?php if ($dir = $search_object->getSortDirection(Issues::STATUS)) echo "sort_{$dir}"; ?> <?php if (!in_array('status', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Status'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::RESOLUTION); ?>" data-sort-field="<?php echo Issues::RESOLUTION; ?>" class="column header sc_resolution <?php if ($dir = $search_object->getSortDirection(Issues::RESOLUTION)) echo "sort_{$dir}"; ?> <?php if (!in_array('resolution', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Resolution'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::CATEGORY); ?>" data-sort-field="<?php echo Issues::CATEGORY; ?>" class="column header sc_category <?php if ($dir = $search_object->getSortDirection(Issues::CATEGORY)) echo "sort_{$dir}"; ?> <?php if (!in_array('category', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Category'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::SEVERITY); ?>" data-sort-field="<?php echo Issues::SEVERITY; ?>" class="column header sc_severity <?php if ($dir = $search_object->getSortDirection(Issues::SEVERITY)) echo "sort_{$dir}"; ?> <?php if (!in_array('severity', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Severity'); ?></div>
                ...
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::REPRODUCABILITY); ?>" data-sort-field="<?php echo Issues::REPRODUCABILITY; ?>" class="column header sc_reproducability <?php if ($dir = $search_object->getSortDirection(Issues::REPRODUCABILITY)) echo "sort_{$dir}"; ?> <?php if (!in_array('reproducability', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Reproducability'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::PRIORITY); ?>" data-sort-field="<?php echo Issues::PRIORITY; ?>" class="column header sc_priority <?php if ($dir = $search_object->getSortDirection(Issues::PRIORITY)) echo "sort_{$dir}"; ?> <?php if (!in_array('priority', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Priority'); ?></div>
                <div class="column header sc_components nosort <?php if (!in_array('components', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Component(s)'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::MILESTONE); ?>" data-sort-field="<?php echo Issues::MILESTONE; ?>" class="column header sc_milestone <?php if ($dir = $search_object->getSortDirection(Issues::MILESTONE)) echo "sort_{$dir}"; ?> <?php if (!in_array('milestone', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Milestone'); ?></div>
                <div class="column header sc_estimated_time nosort sc_datetime <?php if (!in_array('estimated_time', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Estimate'); ?></div>
                <div class="column header sc_spent_time nosort sc_datetime <?php if (!in_array('spent_time', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Time spent'); ?></div>
                <div data-sort-direction="<?php echo $search_object->getSortDirection(Issues::LAST_UPDATED); ?>" data-sort-field="<?php echo Issues::LAST_UPDATED; ?>" class="column header sc_last_updated <?php if ($dir = $search_object->getSortDirection(Issues::LAST_UPDATED)) echo "sort_{$dir}"; ?> sc_datetime <?php if (!in_array('last_updated', $visible_columns)) echo 'hidden'; ?>"><?php echo __('Last updated'); ?></div>
