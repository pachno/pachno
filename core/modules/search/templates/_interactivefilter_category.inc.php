        ...
        <div class="dropdown-container list-mode">
            ...
            <div class="interactive_menu_values">
                <?php foreach ($filter->getAvailableValues() as $category): ?>
                    <input type="checkbox" value="<?php echo $category->getID(); ?>" class="fancycheckbox" name="filters_<?php echo $filter->getFilterKey(); ?>_value_<?php echo $category->getID(); ?>" id="filters_<?php echo $filter->getFilterKey(); ?>_value_<?php echo $category->getID(); ?>" <?php if ($filter->hasValue($category->getID())) echo 'checked'; ?>>
