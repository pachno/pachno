<?php foreach ($search_object->getIssues() as $issue): ?>
    <?php list ($showtablestart, $showheader, $prevgroup_id, $groupby_description) = \pachno\core\modules\search\controllers\Main::resultGrouping($issue, $search_object->getGroupby(), $cc, $prevgroup_id); ?>
