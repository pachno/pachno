<div class="bulk_action_container">
    <form method="post" onsubmit="Pachno.Search.bulkUpdate('<?php echo make_url('issues_bulk_update'); ?>', '<?php echo $mode; ?>');return false;" id="bulk_action_form_<?php echo $mode; ?>" class="bulk_action_form">
        <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
            <input type="hidden" name="project_key" value="<?php echo \pachno\core\framework\Context::getCurrentProject()->getKey(); ?>">
        <?php endif; ?>
        <div class="search_bulk_container <?php echo $mode; ?> unavailable" id="search_bulk_container_<?php echo $mode; ?>">
            ...
            <select name="bulk_action" id="bulk_action_selector_<?php echo $mode; ?>" onchange="Pachno.Search.bulkContainerChanger('<?php echo $mode; ?>');">
            ...
            <?php if (\pachno\core\framework\Context::isProjectContext()): ?>
                <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_assign_milestone_<?php echo $mode; ?>" style="display: none;">
                    <select name="milestone" id="bulk_action_assign_milestone_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>'); if ($(this).getValue() == 'new') { ['bulk_action_assign_milestone_top_name', 'bulk_action_assign_milestone_bottom_name'].each(function(element) { $(element).show(); }); } else { ['bulk_action_assign_milestone_top_name', 'bulk_action_assign_milestone_bottom_name'].each(function(element) { $(element).hide(); }); }">
                        ...
                        <?php foreach (\pachno\core\framework\Context::getCurrentProject()->getMilestonesForIssues() as $milestone_id => $milestone): ?>
            ...
            <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_set_status_<?php echo $mode; ?>" style="display: none;">
                <select name="status" id="bulk_action_set_status_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>');">
                    <?php foreach (\pachno\core\entities\Status::getAll() as $status_id => $status): ?>
            ...
            <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_set_resolution_<?php echo $mode; ?>" style="display: none;">
                <select name="resolution" id="bulk_action_set_resolution_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>');">
            ...
            <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_set_priority_<?php echo $mode; ?>" style="display: none;">
                <select name="priority" id="bulk_action_set_priority_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>');">
            ...
            <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_set_category_<?php echo $mode; ?>" style="display: none;">
                <select name="category" id="bulk_action_set_category_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>');">
            ...
            <span class="bulk_action_subcontainer" id="bulk_action_subcontainer_set_severity_<?php echo $mode; ?>" style="display: none;">
                <select name="severity" id="bulk_action_set_severity_<?php echo $mode; ?>" class="focusable" onchange="Pachno.Search.bulkChanger('<?php echo $mode; ?>');">
            ...
            <input type="submit" class="button disabled" value="<?php echo __('Apply'); ?>" id="bulk_action_submit_<?php echo $mode; ?>">
        </div>
    </form>
    <?php if ($mode == 'bottom'): ?>
