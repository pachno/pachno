...
if ($filter instanceof SearchFilter): ?>
    <?php
        ...
        switch ($filter->getFilterKey())
        {
            ...
            case 'subprojects':
                ?>
                <div class="fancydropdown-container filter" id="interactive_filter_subprojects" data-filterkey="subprojects" data-value="<?= $filter->getValue(); ?>" data-all-value="<?= __('All'); ?>">
                    <div class="fancydropdown">
