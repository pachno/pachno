                    ...
                    <div id="search_column_settings_container" class="column">
                        ...
                        <?php if (!$pachno_user->isGuest()): ?>
                            <div style="padding: 5px;">
                                ...
                                <?= javascript_link_tag(__('Reset columns'), array('onclick' => 'Pachno.Search.resetColumns();return false;')); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
