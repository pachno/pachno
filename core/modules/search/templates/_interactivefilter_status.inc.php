<div class="fancydropdown-container filter" data-filterkey="<?php echo $filter->getFilterKey(); ?>" data-value="<?php echo $filter->getValue(); ?>" data-all-value="<?php echo __('All'); ?>">
    <div class="fancydropdown">
        ...
        <div class="dropdown-container list-mode">
            ...
            <?php if ($filter->getFilterKey() == 'status'): ?>
                <input type="radio" value="open" class="fancycheckbox" name="fs[<?php echo $filter->getFilterKey(); ?>][v]" id="filters_<?php echo $filter->getFilterKey(); ?>_value_open" <?php if ($filter->hasValue('open')) echo 'checked'; ?>>
                ...
                <input type="radio" value="closed" class="fancycheckbox" name="fs[<?php echo $filter->getFilterKey(); ?>][v]" id="filters_<?php echo $filter->getFilterKey(); ?>_value_closed" <?php if ($filter->hasValue('closed')) echo 'checked'; ?>>
            ...
            <div class="filter-values-container">
                <?php foreach ($filter->getAvailableValues() as $status): ?>
                    <input type="checkbox" class="fancycheckbox" name="fs[<?php echo $filter->getFilterKey(); ?>][v]" value="<?= $status->getID(); ?>" id="filters_<?php echo $filter->getFilterKey(); ?>_value_<?php echo $status->getID(); ?>" <?php if ($filter->hasValue($status->getID())) echo ' checked'; ?>>
