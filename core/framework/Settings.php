<?php
    ...
    final class Settings
    {
         ...
         *
         * @return \pachno\core\entities\Group
         */
        public static function getAdminGroup()
        {
            return \pachno\core\entities\Group::getB2DBTable()->selectByID((int) self::get(self::SETTING_ADMIN_GROUP));
        }
        ...
        {
            return (self::isUsingCustomHeaderIcon()) ? Context::getRouting()->generate('showfile', array('id' => self::getHeaderIconID())) : '/logo_white_192.png';
        }
        ...
        public static function getDefaultGroup()
        {
            try
            {
                return \pachno\core\entities\Group::getB2DBTable()->selectByID(self::get(self::SETTING_USER_GROUP));
            }
            catch (\Exception $e)
            {
                return null;
        ...
        public static function getOnlineState()
        {
            try
            {
                return \pachno\core\entities\Userstate::getB2DBTable()->selectByID(self::get(self::SETTING_ONLINESTATE));
            }
            catch (\Exception $e)
            {
                return null;
        ...
        public static function getOfflineState()
        {
            try
            {
                return \pachno\core\entities\Userstate::getB2DBTable()->selectByID(self::get(self::SETTING_OFFLINESTATE));
            }
            catch (\Exception $e)
            {
                return null;
        ...
        public static function getAwayState()
        {
            try
            {
                return \pachno\core\entities\Userstate::getB2DBTable()->selectByID(self::get(self::SETTING_AWAYSTATE));
            }
            catch (\Exception $e)
            {
                return null;
