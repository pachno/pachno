...
class Context
{
     ...
     *
     * @return \pachno\core\framework\Request
     */
     ...
     *
     * @param \pachno\core\entities\Project $project The project, or null if none
     */
     ...
     *
     * @param \pachno\core\entities\Client $client The client, or null if none
     */
    ...
    public static function go()
    {
        ...
        } catch (\pachno\core\framework\exceptions\TemplateNotFoundException $e) {
            \b2db\Core::closeDBLink();
            //header("HTTP/1.0 404 Not Found", true, 404);
            throw $e;

        } catch (\pachno\core\framework\exceptions\ActionNotFoundException $e) {
            \b2db\Core::closeDBLink();
            header("HTTP/1.0 404 Not Found", true, 404);
            throw $e;
    ...
    protected static function generateDebugInfo()
    {
        ...
        if (\b2db\Core::isInitialized())
        {
            ...
            $debug_summary['db']['objecttiming'] = \b2db\Core::getObjectPopulationTiming();
            $debug_summary['db']['objectcount'] = \b2db\Core::getObjectPopulationCount();
        }
