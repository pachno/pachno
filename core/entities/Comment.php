<?php
    ...
    class Comment extends IdentifiableScoped implements MentionableProvider
    {
         ...
         *
         * @return \pachno\core\helpers\ContentParser|TextParserTodo
         */
        ...
        protected function _postSave($is_new)
        {
            if ($is_new)
            {
                ...
                {
                    case self::TYPE_ISSUE:
                        \pachno\core\framework\Event::createNew('core', 'pachno\core\entities\Comment::_postSave', $this, array('issue' => $this->getTarget()))->trigger();
                        break;
                    case self::TYPE_ARTICLE:
                        \pachno\core\framework\Event::createNew('core', 'pachno\core\entities\Comment::_postSave', $this, array('article' => $this->getTarget()))->trigger();
                        break;
                    default:
                        return;
                }
         ...
         *
         * @param \pachno\core\entities\User $user A User
         *
         * @return boolean
         */
        public function canUserDelete(\pachno\core\entities\User $user)
        {
            $can_delete = false;
         ...
         * @return boolean
         */
        public function canUserEdit(\pachno\core\entities\User $user)
        {
            $can_edit = false;
         ...
         * @return boolean
         */
        public function isViewableByUser(\pachno\core\entities\User $user)
        {
            $can_view = false;
        ...
        {
            return ($this->_updated_by instanceof \pachno\core\entities\User) ? $this->_updated_by : \pachno\core\entities\User::getB2DBTable()->selectById($this->_updated_by);
        }
        ...
        public function getPostedBy()
        {
            try
            {
                return ($this->_posted_by instanceof \pachno\core\entities\User) ? $this->_posted_by : \pachno\core\entities\User::getB2DBTable()->selectById($this->_posted_by);
            }
            catch (\Exception $e)
            {
                return null;
        ...
        public function getPostedByID()
        {
            ...
            return ($poster instanceof \pachno\core\entities\common\Identifiable) ? $poster->getID() : null;
        }
        ...
        public function getTarget()
        {
            if ($this->_target === null)
            {
                ...
                {
                    case self::TYPE_ISSUE:
                        $this->_target = \pachno\core\entities\Issue::getB2DBTable()->selectById($this->_target_id);
                        break;
                    case self::TYPE_ARTICLE:
                        $this->_target = tables\Articles::getTable()->selectById($this->_target_id);
                        break;
                    default:
                        $event = \pachno\core\framework\Event::createNew('core', 'Comment::getTarget', $this);
                        $event->trigger();
        ...
        public function toJSON($detailed = true)
        {
            $return_values = array(
                ...
                'posted_by' => ($this->getPostedBy() instanceof \pachno\core\entities\common\Identifiable) ? $this->getPostedBy()->toJSON() : null,
        ...
        {
            return (bool) ($this->getReplyToComment() instanceof \pachno\core\entities\Comment);
        }
