<?php
    ...
    class SavedSearch extends IdentifiableScoped
    {
         ...
         *
         * @var array|\pachno\core\entities\SearchFilter
        ...
        /**
         * @param \pachno\core\entities\User $uid
         */
        ...
        {
            $user = $this->getUser();
            return ($user instanceof \pachno\core\entities\User) ? $user->getID() : 0;
        }
        ...
        protected function _initializeColumns()
        {
            if (!is_array($this->_columns))
            {
                ...
                {
                    if ($columns = \pachno\core\framework\Settings::get('search_scs_'.$this->getTemplateName(), 'core', null, framework\Context::getUser()->getID()))
        ...
        public function hasQuickfoundIssues()
        {
            if ($this->_quickfound_issues === null) {
                ...
                if ($this->getSearchterm()) {
                    preg_replace_callback(\pachno\core\helpers\TextParser::getIssueRegex(), array($this, 'extractIssues'), $this->getSearchterm());
                }
            }
