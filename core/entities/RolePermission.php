<?php
    ...
    /**
     * @Table(name="\pachno\core\entities\tables\RolePermissions")
     */
    class RolePermission extends Identifiable
    {
         ...
         *
         * @param project \pachno\core\entities\Project Project against for which the extended target ID should be obtained.
         *
