<?php
    ...
    abstract class QaLeadable extends Releaseable
    {
        ...
        public function getLeader()
        {
            ...
            if ($this->_leader_team instanceof \pachno\core\entities\Team) {
                return $this->_leader_team;
            } elseif ($this->_leader_user instanceof \pachno\core\entities\User) {
        ...
        public function getLeaderID()
        {
            ...
            return ($leader instanceof \pachno\core\entities\common\Identifiable) ? $leader->getID() : null;
        }

        public function hasLeader()
        {
            return (bool) ($this->getLeader() instanceof \pachno\core\entities\common\Identifiable);
        }

        public function setLeader(\pachno\core\entities\common\Identifiable $leader)
        {
            if ($leader instanceof \pachno\core\entities\Team) {
        ...
        public function getQaResponsible()
        {
            ...
            if ($this->_qa_responsible_team instanceof \pachno\core\entities\Team) {
                return $this->_qa_responsible_team;
            } elseif ($this->_qa_responsible_user instanceof \pachno\core\entities\User) {
        ...
        public function getQaResponsibleID()
        {
            ...
            return ($qa_responsible instanceof \pachno\core\entities\common\Identifiable) ? $qa_responsible->getID() : null;
        }

        public function hasQaResponsible()
        {
            return (bool) ($this->getQaResponsible() instanceof \pachno\core\entities\common\Identifiable);
        }

        public function setQaResponsible(\pachno\core\entities\common\Identifiable $qa_responsible)
        {
            if ($qa_responsible instanceof \pachno\core\entities\Team) {
