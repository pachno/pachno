<?php
    ...
    class WorkflowTransition extends IdentifiableScoped
    {
        ...
        public static function getTemplates()
        {
            ...
            $event = \pachno\core\framework\Event::createNew('core', 'workflow_templates', null, array(), $templates)->trigger();
         ...
         * 
         * @param \pachno\core\entities\WorkflowStep $step A workflow step
         */
        public function setOutgoingStep(\pachno\core\entities\WorkflowStep $step)
        {
         ...
         * 
         * @param \pachno\core\entities\WorkflowStep $step_id A workflow step id
         */
        ...
        public function isAvailableForIssue(\pachno\core\entities\Issue $issue)
        {
        ...
        public function validateFromRequest(\pachno\core\framework\Request $request)
        {
         ...
         */
        public function transitionIssueToOutgoingStepWithoutRequest(\pachno\core\entities\Issue $issue)
        {
         ...
         */
        public function transitionIssueToOutgoingStepFromRequest(\pachno\core\entities\Issue $issue, $request = null)
        {
            ...
            if ($request->hasParameter('comment_body') && trim($request['comment_body'] != '')) {
                $comment = new \pachno\core\entities\Comment();
