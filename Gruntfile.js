module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            dist: {
                files: [
                    { expand: true, cwd: 'public/js', src: ['**/*.js', '!*.min.js'], dest: 'public/js/pachno-<%= pkg.version %>' },
                    { expand: true, cwd: 'public/css', src: ['**/*.css', '!*.min.css'], dest: 'public/css/pachno-<%= pkg.version %>' }
                ]
            }
        },
        // Minify JS file(s).
