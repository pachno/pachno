        ...
        case \pachno\modules\vcs_integration\Vcs_integration::NOTIFICATION_COMMIT_MENTIONED:
            ...
            <h1>
                ...
                <?php echo __('%user_name mentioned you in commit %rev', array(
                    ...
                    '%rev' => javascript_link_tag($notification->getTarget()->getRevisionString(), array('onclick' => "Pachno.UI.Backdrop.show('".make_url('get_partial_for_backdrop', array('key' => 'vcs_integration_getcommit', 'commit_id' => $notification->getTarget()->getID()))."');"))
                    )); ?>
            </h1>
