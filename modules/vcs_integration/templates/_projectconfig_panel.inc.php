    ...
    <?php else: ?>
        ...
        <form accept-charset="<?php echo \pachno\core\framework\Context::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_vcs_settings', array('project_id' => $project->getID())); ?>" method="post" onsubmit="Pachno.UI.formSubmit('<?php echo make_url('configure_vcs_settings', array('project_id' => $project->getID())); ?>', 'vcs'); return false;" id="vcs">
            ...
            <table style="clear: both; width: 780px;" class="padded_table" cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td style="width: 580px;">
                        <select name="vcs_mode" id="vcs_mode" style="width: 100%">
                            <option value="0"<?php if (\pachno\core\framework\Settings::get('vcs_mode_'.$project->getID(), 'vcs_integration') == 0): ?> selected="selected"<?php endif;?>><?php echo __('Disable for this project');?></option>
                            <option value="1"<?php if (\pachno\core\framework\Settings::get('vcs_mode_'.$project->getID(), 'vcs_integration') == 1): ?> selected="selected"<?php endif;?>><?php echo __('Enable for commits applying to existing issues only');?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 580px;">
                        <select name="vcs_workflow" id="vcs_workflow" style="width: 100%">
                            <option value="0"<?php if (\pachno\core\framework\Settings::get('vcs_workflow_'.$project->getID(), 'vcs_integration') == 0): ?> selected="selected"<?php endif;?>><?php echo __('Disable for this project');?></option>
                            <option value="1"<?php if (\pachno\core\framework\Settings::get('vcs_workflow_'.$project->getID(), 'vcs_integration') == 1): ?> selected="selected"<?php endif;?>><?php echo __('Enable for this project');?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr id="http_passkey"<?php if (\pachno\core\framework\Settings::get('access_method_'.$project->getID(), 'vcs_integration') != 1): ?> style="display: none;"<?php endif; ?>>
                    <td style="width: 200px;"><label for="access_passkey"><?php echo __('HTTP Passkey'); ?></label></td>
                    <td style="width: 580px; position: relative;">
                        <input type="text" name="access_passkey" style="width: 100%" id="access_passkey" value="<?php echo \pachno\core\framework\Settings::get('access_passkey_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                    </td>
                </tr>
                <tr>
                    <td style="width: 200px;"><label for="browser_url"><?php echo __('URL to repository browser'); ?></label></td>
                    <td style="width: 580px; position: relative;">
                        <input type="text" name="browser_url" style="width: 100%" id="browser_url" value="<?php echo \pachno\core\framework\Settings::get('browser_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                    </td>
                </tr>
                <tr>
            ...
            <div id="vcs_custom_urls">
                ...
                <table style="clear: both; width: 780px; margin-top: 10px" class="padded_table" cellpadding=0 cellspacing=0>
                    <tr>
                        ...
                        <td style="width: 580px; position: relative;">
                            <input type="text" name="commit_url" style="width: 100%"s id="commit_url" value="<?php echo \pachno\core\framework\Settings::get('commit_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 200px;"><label for="log_url"><?php echo __('File log page'); ?></label></td>
                        <td style="width: 580px; position: relative;">
                            <input type="text" name="log_url" style="width: 100%" id="log_url" value="<?php echo \pachno\core\framework\Settings::get('log_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 200px;"><label for="blob_url"><?php echo __('File blob/view page'); ?></label></td>
                        <td style="width: 580px; position: relative;">
                            <input type="text" name="blob_url" style="width: 100%" id="blob_url" value="<?php echo \pachno\core\framework\Settings::get('blob_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 200px;"><label for="diff_url"><?php echo __('Diff page'); ?></label></td>
                        <td style="width: 580px; position: relative;">
                            <input type="text" name="diff_url" style="width: 100%" id="diff_url" value="<?php echo \pachno\core\framework\Settings::get('diff_url_'.$project->getID(), 'vcs_integration'); ?>" style="width: 100;">
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <tr>
                    <td colspan="2">
                        <div class="save-button-container">
                            ...
                            <input id="vcs_button" type="submit" class="button" value="<?php echo __('Save'); ?>">
                        </div>
                    </td>
                </tr>
            </table>
