<?php
    ...
    namespace pachno\modules\vcs_integration\cli;

    use pachno\modules\vcs_integration\Vcs_integration;
     ...
     * @subpackage vcs_integration
     */
    class Report extends \pachno\core\framework\cli\Command
    {
        ...
        public function do_execute()
        {
            ...
            try
            {
                ...
                $project_row = \pachno\core\entities\tables\Projects::getTable()->getById($project_id, false);
                \pachno\core\framework\Context::setScope(new \pachno\core\entities\Scope($project_row[\pachno\core\entities\tables\Projects::SCOPE]));
                $project = new \pachno\core\entities\Project($project_id, $project_row);
            }
            catch (\Exception $e)
            {
            ...
            if (\pachno\core\framework\Settings::get('access_method_'.$project->getKey()) == Vcs_integration::ACCESS_HTTP)
            {
