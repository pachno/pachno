define(['prototype', 'effects', 'controls', 'scriptaculous', 'jquery', 'TweenMax', 'GSDraggable', 'notify', 'calendarview', 'jquery-ui', 'jquery.markitup', 'spectrum'],
    ...
    //					progressBar.textContent = progressBar.value; // Fallback for unsupported browsers.
        ...
        Pachno.Main.Comment.update = function (url, cid) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Edition.edit = function (url, edition_id)
        {
            Pachno.Main.Helpers.Backdrop.show(url);
        };

        Pachno.Project.Edition.remove = function (url, eid) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Edition.add = function (url) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Edition.submitSettings = function (url, edition_id) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Edition.Component.add = function (url, cid) {
            Pachno.Main.Helpers.ajax(url, {
                loading: {
                    callback: function () {
        ...
        Pachno.Project.Edition.Component.remove = function (url, cid) {
            Pachno.Main.Helpers.ajax(url, {
                loading: {
                    callback: function () {
        ...
        Pachno.Project.Component.update = function (url, cid) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Component.add = function (url) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Component.remove = function (url, cid) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Project.Component.edit = function (url, component_id)
        {
            Pachno.Main.Helpers.Backdrop.show(url);
        }
        ...
        Pachno.Config.Issuetype.showOptions = function (url, id) {
        ...
        Pachno.Config.Issuetype.Choices.update = function (url, id) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Config.Workflows.Scheme.copy = function (url, scheme_id) {
            Pachno.Main.Helpers.ajax(url, {
        ...
        Pachno.Config.Workflows.Scheme.remove = function (url, scheme_id) {
            Pachno.Main.Helpers.ajax(url, {
                loading: {
                    indicator: 'fullpage_backdrop',
                    show: 'fullpage_backdrop_indicator',
        ...
        Pachno.Config.Workflows.Scheme.update = function (url, scheme_id) {
            Pachno.Main.Helpers.ajax(url, {
